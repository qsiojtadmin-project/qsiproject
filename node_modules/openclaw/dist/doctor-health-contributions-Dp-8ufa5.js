...
async function runGatewayConfigHealth(ctx) {
	...
	const { note } = await import("./note-CCy6gegM.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyFlatAuthProfileStores } = await import("./doctor-auth-flat-profiles-DULwGCfy.js");
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-B7TaZ_4K.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-Z9I67cWD.js");
	const { buildGatewayConnectionDetails } = await import("./call-BtdvPwz6.js");
	const { note } = await import("./note-CCy6gegM.js");
...
async function runGatewayAuthHealth(ctx) {
	...
	const { resolveGatewayAuth } = await import("./auth-5ZdP1mwe.js");
	const { note } = await import("./note-CCy6gegM.js");
	const { randomToken } = await import("./onboard-helpers-Nqe-OK2G.js");
...
async function runCommandOwnerHealth(ctx) {
	const { noteCommandOwnerHealth } = await import("./doctor-command-owner-n7nvZtkr.js");
	noteCommandOwnerHealth(ctx.cfg);
}
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-BxCc8uxD.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-BFsq8hzj.js");
	const { note } = await import("./note-CCy6gegM.js");
...
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-BCspHaiy.js");
...
async function runPluginRegistryHealth(ctx) {
	const { maybeRepairPluginRegistryState } = await import("./doctor-plugin-registry--WvpYYpM.js");
...
async function runReleaseConfiguredPluginInstallsHealth(ctx) {
	...
	const { maybeRunConfiguredPluginInstallReleaseStep } = await import("./release-configured-plugin-installs-CvfnGeYf.js");
	const { note } = await import("./note-CCy6gegM.js");
...
async function runStateIntegrityHealth(ctx) {
	const { noteStateIntegrity } = await import("./doctor-state-integrity-D4sTqFTZ.js");
	await noteStateIntegrity(ctx.cfg, ctx.prompter, ctx.configPath);
}
async function runSessionLocksHealth(ctx) {
	const { noteSessionLockHealth } = await import("./doctor-session-locks-BMnxJMlj.js");
	await noteSessionLockHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runSessionTranscriptsHealth(ctx) {
	const { noteSessionTranscriptHealth } = await import("./doctor-session-transcripts-B1yBrYKR.js");
	await noteSessionTranscriptHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore, noteLegacyWhatsAppCrontabHealthCheck } = await import("./doctor-cron-Bu62Yrsf.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, noteSandboxScopeWarnings } = await import("./doctor-sandbox-CB2tBz_v.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-ln9yMO24.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides } = await import("./doctor-platform-notes-BZV7Lw4S.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-BJF1agXf.js");
...
async function runSecurityHealth(ctx) {
	const { noteSecurityWarnings } = await import("./doctor-security-B9irqPko.js");
	await noteSecurityWarnings(ctx.cfg);
}
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-KTKgLGwB.js");
	await noteChromeMcpBrowserReadiness(ctx.cfg);
}
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./oauth-tls-preflight-_KSHbfJm.js");
...
async function runHooksModelHealth(ctx) {
	...
	const { DEFAULT_MODEL, DEFAULT_PROVIDER } = await import("./defaults-DKZsPKqU.js");
	const { loadModelCatalog } = await import("./model-catalog-C6Mkn6Hf.js");
	const { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel } = await import("./model-selection-vj2KsHKW.js");
	const { note } = await import("./note-CCy6gegM.js");
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-CV5QrL80.js");
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DsclBEUf.js");
	const { note } = await import("./note-CCy6gegM.js");
...
async function runWorkspaceStatusHealth(ctx) {
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-BaAKTxuf.js");
	noteWorkspaceStatus(ctx.cfg);
}
async function runSkillsHealth(ctx) {
	const { maybeRepairSkillReadiness } = await import("./doctor-skills-BiCrr7EV.js");
...
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-Dhk85Irg.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-wG6i3YX3.js");
...
async function runGatewayHealthChecks(ctx) {
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-DijleVZm.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-Bril_LLu.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-FfCfeaZ4.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-DGYEVL7E.js");
...
async function runWriteConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-DJsx2K9v.js");
	const { applyWizardMetadata } = await import("./onboard-helpers-Nqe-OK2G.js");
	const { CONFIG_PATH, replaceConfigFile } = await import("./config/config.js");
	const { logConfigUpdated } = await import("./logging-CttJs1RN.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-JzdWovLn.js");
	const { noteWorkspaceBackupTip } = await import("./doctor-state-integrity-D4sTqFTZ.js");
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-Csw6EBU6.js");
	const { note } = await import("./note-CCy6gegM.js");
