...
import { t as isTruthyEnvValue } from "./env-DzjAzpl4.js";
...
import { r as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-DcKQMcaX.js";
import { r as normalizeProviderId } from "./provider-id-dd60CFPS.js";
import { d as createDiagnosticTraceContextFromActiveScope, f as formatDiagnosticTraceparent, l as createChildDiagnosticTraceContext, p as freezeDiagnosticTraceContext, r as emitTrustedDiagnosticEvent } from "./diagnostic-events-CKGnBU6G.js";
import { t as createSubsystemLogger } from "./subsystem-Bhq-McUP.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey } from "./session-key-utils-B7QL53SS.js";
import { c as normalizeAgentId } from "./session-key-BSlq04Dw.js";
import { g as listAgentEntries, m as resolveSessionAgentIds } from "./agent-scope-BBUKdu9R.js";
import { Q as resolveOwnerDisplaySetting, i as getRuntimeConfig } from "./io-BcjzQKwO.js";
import "./defaults-Bnf56S7k.js";
import "./config-DZli1BwL.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-C5_wU4PI.js";
...
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-CLc3nWid.js";
import { t as resolveAgentRuntimePolicy } from "./agent-runtime-policy-DXjPFxmm.js";
import { S as listRegisteredAgentHarnesses } from "./loader-CiaemmFD.js";
import { D as listRegisteredPluginAgentPromptGuidance } from "./types-iTIQmVd6.js";
import { c as fireAndForgetBoundedHook, t as getGlobalHookRunner } from "./hook-runner-global-BxiXdopW.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-cXQdYJwN.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-DiLiL9Ik.js";
import { c as resolveAssistantMessagePhase, o as parseAssistantTextSignature } from "./chat-message-content-BxjkC7fw.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-CVbRKMg0.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-B5ieQ54a.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-D0x4hHVV.js";
import { o as resolveDefaultModelForAgent } from "./model-selection-DZLznUc9.js";
import { f as setActiveEmbeddedRun, p as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun } from "./runs-DWPap98a.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DthSW-9A.js";
import { u as stripRuntimeContextCustomMessages } from "./internal-runtime-context-TysOkYqY.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-DdI5zu1Z.js";
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-DFqrPvsW.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-Cz177X8d.js";
import { i as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-BTgIv8Wi.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText, s as stripLeadingSilentToken } from "./tokens-B-mjBMYM.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-DW-_teth.js";
import { i as normalizeToolName } from "./tool-policy-shared-MN-JZIlL.js";
import "./tool-policy-BL2axuiI.js";
import { i as getPluginToolMeta } from "./tools-D9CRirqH.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-BKiOv48e.js";
import "./pi-bundle-mcp-tools-pJzj9H_j.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DElryB-x.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-hWuvs9G3.js";
import { m as MAX_IMAGE_BYTES } from "./mime-CDoSsIec.js";
import { n as resolveEmbeddedAgentHarnessFallback, r as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-BfJK4tkl.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-BOhQMwjb.js";
import { t as parseInlineDirectives } from "./directive-tags-BBgnBiTv.js";
import { t as isCliRuntimeAlias } from "./model-runtime-aliases-DK3pJEmN.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-DL4WTvzI.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-DdsbR88N.js";
import { b as stripProviderPrefix, x as isEmbeddedMode, y as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-BDF6gNXk.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-DlHl79gd.js";
import { t as getMachineDisplayName } from "./machine-name-WdekediH.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-BYGZVFo_.js";
import { n as redactConfigObject } from "./redact-snapshot-BJoGiMYD.js";
import { n as resolveCommitHash } from "./git-commit-Ct6umZnT.js";
import { t as resolveOsSummary } from "./os-summary-BFfoy_km.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-C90dcV06.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-DCDclho7.js";
import { n as toTrajectoryToolDefinitions, r as getQueuedFileWriter, t as createTrajectoryRuntimeRecorder } from "./runtime-qu4g1jFz.js";
import { t as parseBooleanValue } from "./boolean-DuHGePJF.js";
import { n as buildTtsSystemPromptHint } from "./tts-runtime-C_xQKyqz.js";
import "./tts-Cm0MRYDz.js";
import { t as isReasoningTagProvider } from "./provider-utils-DUyHW6Qz.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-DlUADZXK.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-CMeJGaIy.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-C0Kjcnqo.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-CX9HyLGt.js";
import { a as resolveBootstrapMaxChars, o as resolveBootstrapPromptTruncationWarningMode, s as resolveBootstrapTotalMaxChars } from "./google-BuAT977e.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CmKX6fUV.js";
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-CfCnVG6Z.js";
import { a as isMessagingToolDuplicateNormalized, c as downgradeOpenAIFunctionCallReasoningPairs, l as downgradeOpenAIReasoningBlocks, n as validateGeminiTurns, o as normalizeTextForComparison, t as validateAnthropicTurns } from "./pi-embedded-helpers-Cj7WbZOK.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-CZAeHvyT.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BbbvhMCD.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolHints } from "./channel-tools-DXjS43CZ.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-BP5AnxUu.js";
import { a as isTimeoutError } from "./failover-error-BCrrEJFL.js";
import { t as buildModelAliasLines } from "./model-alias-lines-DjEyeELP.js";
import { t as sanitizeForConsole } from "./console-sanitize-B-EpNDrW.js";
import { u as resolveModelAuthMode } from "./model-auth-JUD_7CAF.js";
import { n as resolveTranscriptPolicy, o as supportsModelTools, r as shouldAllowProviderOwnedThinkingReplay } from "./tool-result-middleware-MfiOC1ji.js";
import { g as sanitizeTransportPayloadText, p as mergeTransportHeaders, v as buildGuardedModelFetch } from "./openai-transport-stream-BZZu1dNP.js";
import { t as log$4 } from "./logger-DXbWbpA5.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-CZ6mL9Zq.js";
import { B as collectRuntimeChannelCapabilities, C as sanitizeSessionHistory, D as limitHistoryTurns, E as getDmHistoryLimitFromSessionKey, F as resolveCompactionTimeoutMs, G as releaseWsSession, H as dropReasoningFromHistory, I as isCacheTtlEligibleProvider, K as buildStreamErrorAssistantMessage, L as readLastCacheTtlTimestamp, O as buildEmbeddedExtensionFactories, R as guardSessionManager, S as normalizeAssistantReplayContent, T as buildEmbeddedMessageActionDiscoveryInput, U as dropThinkingBlocks, V as assessLastAssistantMessage, W as isZeroUsageEmptyStopAssistantTurn, _ as resolveEmbeddedAgentBaseStreamFn, a as flushPendingToolResultsAfterIdle, b as prewarmSessionFile, c as PI_RESERVED_TOOL_NAMES, d as toSessionToolAllowlist, f as applySystemPromptOverrideToSession, g as resolveEmbeddedAgentApiKey, h as describeEmbeddedAgentStreamStrategy, l as collectAllowedToolNames, m as createSystemPromptOverride, o as mapThinkingLevel, p as buildEmbeddedSystemPrompt, r as shouldRotateCompactionTranscript, s as splitSdkTools, t as rotateTranscriptAfterCompaction, u as collectRegisteredToolNames, v as resolveEmbeddedAgentStreamFn, w as validateReplayTurns, x as trackSessionManagerAccess, y as resolveEmbeddedRunSkillEntries, z as repairSessionFileIfNeeded } from "./compaction-successor-transcript-ZByj7D6a.js";
import { g as streamWithPayloadPatch } from "./provider-model-shared-Cu3necQt.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-UKicgybr.js";
import { t as registerProviderStreamForModel } from "./provider-stream-CFMwcPPe.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-kS2M5yKA.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-ByLgf0mB.js";
import { C as isMessagingToolSendAction, S as isMessagingTool, _ as filterToolResultMediaUrls, b as sanitizeToolArgs, d as runAgentCleanupStep, f as formatToolAggregate, g as extractToolResultText, h as extractToolResultMediaArtifact, l as logAgentRuntimeToolDiagnostics, m as extractToolErrorMessage, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractMessagingToolSend, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as normalizeAgentRuntimeTools, v as isToolResultError, x as sanitizeToolResult, y as isToolResultTimedOut } from "./attempt.tool-run-context-B2TarhD3.js";
import { r as parseFenceSpans } from "./fences-CjkSni-h.js";
import { r as splitMediaFromOutput } from "./parse-BEgFyufl.js";
import { t as collectTextContentBlocks } from "./content-blocks-Bj4_UFub.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-CfczjJyG.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-B_HkcC7e.js";
import { d as parseReplyDirectives } from "./deliver-BCtMABIO.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-8wTXlIug.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-DG8gvSOO.js";
import { n as hasCommittedMessagingToolDeliveryEvidence, r as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-YYNfZn44.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-7sf1gYDj.js";
import { g as createPreparedEmbeddedPiSettingsManager, h as formatContextLimitTruncationNotice, p as truncateOversizedToolResultsInSessionManager, u as resolveLiveToolResultMaxChars } from "./compaction-DSk2RlsY.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-oSM7KEmJ.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-IGOpj1AH.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-DecOHXnw.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-J9lznXGK.js";
import { i as resolveSubagentToolPolicyForSession, n as resolveEffectiveToolPolicy, r as resolveGroupToolPolicy } from "./pi-tools.policy-Dk54BbWF.js";
import { o as resolveSandboxContext } from "./sandbox-BULaIO3n.js";
import { t as detectRuntimeShell } from "./shell-utils-D4beho7Z.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DH7uH9-E.js";
import { s as resolveSkillsPromptForRun } from "./workspace-Dktak15t.js";
import "./skills-f1xjPdqK.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-C2rNwB1A.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-D4xqJn6G.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-D3JTe0id.js";
import "./tool-loop-detection-D2aQFve3.js";
import { T as visitObjectContentBlocks, o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-BF5MzTUo.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-DtfjaG6U.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-DZOUXdSu.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-CkQ8doYl.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-DQu1kW8q.js";
import { t as parseGeminiAuth } from "./gemini-auth-BVQi_yxN.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-D-cG-TLI.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-CfOF7etk.js";
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-CGtyIpGC.js";
...
import { t as resolveBootstrapMode } from "./bootstrap-mode-Ckk9Ql4G.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, o as shouldUseOpenAIWebSocketTransportForAttempt, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-GDm-G0Xv.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CHmYrGWn.js";
import { t as detectAndLoadPromptImages } from "./images-DezUqaBH.js";
import { i as resolveRuntimeContextPromptParts, r as queueRuntimeContextForNextTurn, t as buildRuntimeContextSystemContext } from "./runtime-context-prompt-BusW75hm.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-BvLIvZFj.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-Die-LGee.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-xThZVsiw.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-BGSNSEMR.js"));
