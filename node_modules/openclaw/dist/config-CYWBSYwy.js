...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-BxG5HEpf.js";
import "./ssrf-runtime-B8FMdlKm.js";
import "./retry-runtime-BkqmNw8g.js";
import "./secret-input-runtime-eNDb6OtM.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-DLqDA7yI.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-BuUFFeBg.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-CjaEbyII.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-DO0x-B2n.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-Do9fxEY5.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-Y9QtI0Mc.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-DqN9lViB.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-CXlGqewd.js"), import("./logging-pZti7juk.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-B1kqcD73.js").then((credentialsReadModule) => ({
