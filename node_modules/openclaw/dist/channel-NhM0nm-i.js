...
import { c as parseThreadSessionSuffix } from "./session-key-utils-B7QL53SS.js";
import { n as normalizeAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-CKs_R3Vn.js";
import { r as buildChannelConfigSchema } from "./config-schema-D8xSr2KA.js";
...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-ByjTayCI.js";
import { a as createActionGate, f as readNumberParam, g as readStringParam, n as ToolAuthorizationError } from "./common-Rq2JD8YM.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-D9pao_xK.js";
import { n as describeAccountSnapshot } from "./account-helpers-Dcsr8uwV.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-9idNq57p.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-BDe4UCri.js";
import "./channel-core-DVqeqMZC.js";
import "./routing-By0dru2e.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-CTiKRfVl.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-e_YuNtUm.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-DudsbHW4.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-DbtV6NiP.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DzoasTPF.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-VB8Jg_fn.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Dhng7tBz.js";
import { t as extractToolSend } from "./tool-send-Dg-D_jdb.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-OHe4dCWD.js";
import "./approval-delivery-runtime-CoVdtadl.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-B6bNghlQ.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-C_ekHj0k.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-45ldha4A.js";
import "./approval-native-runtime-Dq9FmPl8.js";
import "./outbound-runtime-Bz1q1EZO.js";
import "./conversation-runtime-O9M0wjdI.js";
import { t as chunkTextForOutbound } from "./text-chunking-DGDTrXRa.js";
import "./channel-status-CI_1M3Ct.js";
import "./channel-config-primitives-C3crF8gU.js";
import "./channel-actions-BEVsS4Hc.js";
import "./session-store-runtime-Ckj5mqxD.js";
import "./string-coerce-runtime-BeK4jl1z.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-bUaTwlWZ.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-CPhiTn4c.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-DLqDA7yI.js";
import { a as resolveMatrixAccountConfig } from "./account-config-CjaEbyII.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-BEW6rKrt.js";
import { n as normalizeMatrixUserId } from "./allowlist-tUDlHaQc.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-B0eFs6xD.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-BbZGrhpT.js";
import { t as formatMatrixErrorMessage } from "./errors-Cd78wLHY.js";
import { n as matrixConfigAdapter, t as MatrixConfigSchema } from "./config-schema-BXaz1GUy.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-BTMZ7TxR.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-CgZt-iO3.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-D0E81So0.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-B8CjfQDe.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-D8cU5fB7.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-DYZXoCF5.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-DHbjoAln.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-_fxjrO9u.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-DpJcie6K.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BH7bErtt.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-C5tqJGFZ.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-C5tqJGFZ.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-VJoh4m0W.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
