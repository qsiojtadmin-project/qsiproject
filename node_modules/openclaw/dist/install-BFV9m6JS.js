...
import { A as formatPrereleaseResolutionError, N as parseRegistryNpmSpec, T as resolvePackageExtensionEntries, c as validatePackageExtensionEntriesForInstall, j as isPrereleaseResolutionAllowed } from "./discovery-B19Xdk1_.js";
import { r as runCommandWithTimeout } from "./exec-DIR5K8F-.js";
import { i as resolveNpmSpecMetadata } from "./install-source-utils-C95C4qxy.js";
import { i as listOfficialExternalPluginCatalogEntries, o as resolveOfficialExternalPluginId, s as resolveOfficialExternalPluginInstall } from "./official-external-plugin-catalog-7ZNzcN2z.js";
import { n as createSafeNpmInstallEnv, t as createSafeNpmInstallArgs } from "./safe-package-install-Bb0TSQZL.js";
import { n as packageNameMatchesId } from "./install-safe-path-C1AaOfwl.js";
import { a as resolveDefaultPluginNpmDir, c as validatePluginId, n as matchesExpectedPluginId, r as resolveDefaultPluginExtensionsDir, s as safePluginInstallFileName, t as encodePluginInstallDirName } from "./install-paths-DaUbjF4k.js";
import { t as resolveNpmIntegrityDriftWithDefaultMessage } from "./npm-integrity-C_aogWnW.js";
...
const pluginInstallRuntimeLoader = createLazyImportLoader(() => import("./install.runtime-DQ-ui3nL.js"));
...
const defaultLogger = {};
function listTrustedOfficialNpmPluginPackages() {
...
function isTrustedOfficialNpmPluginInstall(params) {
	if (params.installPolicyRequest?.kind !== "plugin-npm") return false;
	...
	return expectedPluginId !== void 0 && params.packageName === requested.name && params.pluginId === expectedPluginId;
}
...
async function validatePackagePluginInstallSource(params) {
	...
	const trustedOfficialInstall = params.trustedSourceLinkedOfficialInstall || isTrustedOfficialNpmPluginInstall({
		installPolicyRequest: params.installPolicyRequest,
		packageName: pkgName,
		pluginId
	});
