...
import "./session-binding-runtime-DaCqapk6.js";
import { a as resolveMatrixAccountConfig } from "./account-config-CjaEbyII.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-B2KrzxJ9.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTarget } from "./approval-reactions-BGl8SLoQ.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-CpGryQ51.js";
...
function loadApprovalReactionAuth() {
	approvalReactionAuthPromise ??= import("./approval-reaction-auth-BQJUIzuv.js");
	return approvalReactionAuthPromise;
}
function loadExecApprovalResolver() {
	execApprovalResolverPromise ??= import("./exec-approval-resolver-B-3eJY99.js");
