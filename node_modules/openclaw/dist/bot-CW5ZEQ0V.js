...
import { i as getChildLogger } from "./logger-7EZMSIuN.js";
import { t as createSubsystemLogger } from "./subsystem-Bhq-McUP.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-CX0Bl8ZU.js";
import { n as normalizeAccountId } from "./account-id-CKs_R3Vn.js";
import { d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey } from "./session-key-BSlq04Dw.js";
import { S as resolveDefaultAgentId, b as resolveAgentDir } from "./agent-scope-BBUKdu9R.js";
import { i as getRuntimeConfig } from "./io-BcjzQKwO.js";
import { i as getRuntimeConfigSnapshot } from "./runtime-snapshot-Bgtbceve.js";
import { r as replaceConfigFile } from "./mutate-D-EdwGeB.js";
import { l as fireAndForgetHook } from "./hook-runner-global-BxiXdopW.js";
import { t as createDedupeCache } from "./dedupe-781ULZTO.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BuesQqCh.js";
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-CZGTKQyN.js";
import { t as loadSessionStore } from "./store-load-BIF3vVgu.js";
import { d as resolveSessionStoreEntry, o as updateSessionStore } from "./store-Cv5z_jxw.js";
import { t as resolveAndPersistSessionFile } from "./session-file-BQ1eV6Lo.js";
import { S as findModelInCatalog } from "./model-selection-shared-B6u2OWdP.js";
import { o as resolveDefaultModelForAgent } from "./model-selection-DZLznUc9.js";
import { a as modelSupportsVision, r as loadModelCatalog } from "./model-catalog-Cl9-8vZQ.js";
import { f as findCodeRegions, p as isInsideCode, u as stripReasoningTagsFromText } from "./assistant-visible-text-DFqrPvsW.js";
import { n as MediaFetchError } from "./fetch-DYuedlza.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-BNXLKYs7.js";
import { t as resolveAckReaction } from "./identity-BMoXQgIH.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-Dr322o7Y.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-4-Os8_TI.js";
import { n as createOutboundPayloadPlan, o as projectOutboundPayloadPlanForDelivery } from "./deliver-BCtMABIO.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-8wTXlIug.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-BE8DrRTa.js";
import { c as resolveChannelStreamingPreviewToolProgress, i as resolveChannelStreamingBlockEnabled } from "./channel-streaming-DQTVmyXP.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-D7yuCiqB.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-P44RAWI9.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-D9pao_xK.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-uGoWkLGV.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CvQQZfWL.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-DtfrL7Z0.js";
import "./text-runtime-BDbNycHL.js";
import "./routing-By0dru2e.js";
import { a as getPluginCommandSpecs } from "./commands-CVKHcrEn.js";
import { f as parsePluginBindingApprovalCustomId, i as buildPluginBindingResolvedText, m as resolvePluginConversationBindingApproval } from "./conversation-binding-C-Pb_IcK.js";
import "./error-runtime-Bv3l0gi6.js";
import { n as listChatCommands } from "./commands-registry-list-DNiVJfA3.js";
import { n as maybeResolveTextAlias, r as normalizeCommandBody } from "./commands-registry-normalize-BcHaSkb9.js";
import { n as isAbortRequestText } from "./abort-primitives-BCoLarFb.js";
import { t as hasControlCommand } from "./command-detection-BSv7N0_l.js";
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-Cn8HYSQn.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-B1Qgdl4N.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-CPTx_PkL.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-Ds4bS7vU.js";
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-DGrAoZId.js";
import { n as resolveControlCommandGate, t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-Dm-6Bza0.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-MzhsY7Rp.js";
import { c as clearHistoryEntriesIfEnabled, d as recordPendingHistoryEntryIfEnabled, o as buildPendingHistoryContextFromMap } from "./history-B6WIbVXW.js";
import { n as hasFinalChannelTurnDispatch } from "./dispatch-result-DZvgeOS8.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-yEAwcntk.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-bLmSGU0b.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-jQ5Zc-np.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline--n5smv45.js";
import { t as firstDefined } from "./allow-from-iYFT2oMH.js";
import "./channel-policy-CTiKRfVl.js";
import "./reply-history-fX9ql_9i.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-CNsTmISm.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-VB8Jg_fn.js";
import "./runtime-env-DxZvavA4.js";
import { d as parseExecApprovalCommandText } from "./exec-approval-reply-0k4hZAz9.js";
import "./approval-reply-runtime-YFpsGWS6.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-CYNC7r_c.js";
import { n as resolveNativeCommandsEnabled, r as resolveNativeSkillsEnabled, t as isNativeCommandsExplicitlyDisabled } from "./commands-9qfbO4XO.js";
import "./config-mutation-LfSo4gyJ.js";
import { t as resolveCommandAuthorization } from "./command-auth-D6tn5p10.js";
import { t as resolveStoredModelOverride } from "./stored-model-override-C4nMMzAz.js";
import { n as isBtwRequestText } from "./btw-command-CAQvRXwf.js";
import { t as generateConversationLabel } from "./conversation-label-generator-DL2929DN.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-jxTu7uhs.js";
import "./reply-chunking-DwKx7qFI.js";
import { a as runInboundReplyTurn } from "./inbound-reply-dispatch-TqOutmKH.js";
import "./outbound-runtime-Bz1q1EZO.js";
import "./runtime-config-snapshot-DTRzP9mu.js";
import "./model-session-runtime-Dmo3oG-Y.js";
import "./media-runtime-1x2Ns6T7.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-CzXC6_8l.js";
import "./conversation-runtime-O9M0wjdI.js";
import "./agent-runtime-BBN9s5fZ.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-D4cSst7z.js";
import "./security-runtime-D35m9RFX.js";
import "./hook-runtime-DzccobKk.js";
import "./markdown-table-runtime-BEgGw_S1.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-Cc1CS4jb.js";
import "./command-auth-M-JfQHmX.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-BAHd8RJQ.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-qoJgDxzy.js";
import { n as formatModelsAvailableHeader } from "./commands-models-CAXB6CgC.js";
import "./command-auth-native-Bq8scPho.js";
import "./command-primitives-runtime-DMkv91ri.js";
import "./command-status-C6HvzvoQ.js";
import "./command-detection-w2HVFuKX.js";
import "./command-surface-BDjb9ZJd.js";
import { n as DEFAULT_EMOJIS, r as DEFAULT_TIMING } from "./channel-feedback-xFkuJQNU.js";
import { r as shouldDebounceTextInbound } from "./channel-inbound-Cn6F34zZ.js";
import { n as toLocationContext, t as formatLocationText } from "./location-yda_svao.js";
import "./session-store-runtime-Ckj5mqxD.js";
import "./models-provider-runtime-CYz06oSW.js";
import "./skill-commands-runtime-BIboEsQp.js";
import "./native-command-config-runtime-COvn183X.js";
import { t as mergeTelegramAccountConfig } from "./account-config-FvsMn2zZ.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-Kp2EKZBA.js";
import { $ as shouldUseTelegramDmThreadSession, A as isSafeToRetrySendError, B as buildTelegramRoutingTarget, C as withTelegramApiErrorLogging, D as renderTelegramHtmlText, F as tagTelegramNetworkError, H as buildTypingThreadParams, I as buildGroupLabel, J as resolveTelegramForumThreadId, K as resolveTelegramDirectPeerId, L as buildTelegramGroupFrom, Q as resolveTelegramThreadSpec, R as buildTelegramGroupPeerId, U as describeReplyTarget, V as buildTelegramThreadParams, W as extractTelegramForumFlag, X as resolveTelegramReplyId, Y as resolveTelegramGroupAllowFromContext, Z as resolveTelegramStreamMode, a as editMessageTelegram, at as getTelegramTextParts, ct as normalizeForwardedContext, dt as isSenderAllowed, et as withResolvedTelegramForumFlag, ft as normalizeAllowFrom, g as recordSentMessage, it as extractTelegramLocation, j as isTelegramClientRejection, k as isRecoverableTelegramNetworkError, mt as resolveSenderAllowMatch, nt as buildSenderName, ot as hasBotMention, pt as normalizeDmAllowFromWithStore, q as resolveTelegramForumFlag, rt as expandTextLinks, tt as buildSenderLabel, ut as resolveTelegramPrimaryMedia, x as buildInlineKeyboard, z as buildTelegramParentPeer } from "./send-7IxqIgtx.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-B4-8iE7X.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-DpfBmTUv.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-CcZW0dev.js";
import { n as resolveTelegramRequestTimeoutMs } from "./request-timeouts-DLyaSc2X.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-FLknIgzL.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-84Glantp.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-B_0u9x_g.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-3mG9K13M.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-COa8uMRV.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-B7a-IgqU.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-b1KhV65k.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-DrGPpQG6.js");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-C68ftT1Y.js")).defaultTelegramBotDeps;
