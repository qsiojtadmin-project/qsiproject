...
import { o as getResolvedLoggerSettings } from "./logger-7EZMSIuN.js";
import { t as danger } from "./globals-CX0Bl8ZU.js";
...
import { i as getBundledChannelSetupPlugin } from "./bundled-Di2LIL8m.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-D_T9eteF.js";
import "./plugins-DMPVpaLC.js";
import "./logging-DJCGPfPx.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-DaMp0P2R.js";
import { i as callGateway } from "./call-HHsCuKDy.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-BX9yzI9u.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-taXV3ejv.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-CrYoXDx1.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CAx9II92.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-qC0srFJg.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-BUzY4TDJ.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-DBSmr93w.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-CAvOscDw.js";
import { n as resolveLogFile } from "./log-tail-BnNzWJKb.js";
import { t as parseLogLine } from "./parse-log-line-Dtbx7otz.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-BsJcZiAW.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-PX85dRpY.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-7Z6PqUuK.js";
import { t as channelsListCommand } from "./list-BXEAzJBH.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-D55vN32b.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-D7-8E4KZ.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-BbACi2jb.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-TbBi6aF2.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-CjBiWo6Q.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-DWF5wejV.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-BCP60S68.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-Bk-quvhA.js");
