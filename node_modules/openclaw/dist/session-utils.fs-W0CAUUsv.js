...
import { n as stripInboundMetadata, t as extractInboundSenderLabel } from "./strip-inbound-meta-BX8nyryk.js";
import { i as hasNonzeroUsage, o as normalizeUsage, r as deriveSessionTotalTokens } from "./usage-BOhQMwjb.js";
...
async function readSessionTitleFieldsFromTranscriptAsync(sessionId, storePath, sessionFile, agentId, opts) {
	...
	let firstUserMessage = null;
	for (const entry of index.entries) {
		const msg = entry.record.message;
