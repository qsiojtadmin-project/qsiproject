...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-DzjAzpl4.js";
...
import { i as isKnownSecretTargetId } from "./target-registry-DuINnI-4.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-DcKQMcaX.js";
import { c as setDiagnosticsEnabledForProcess, i as isDiagnosticsEnabled, u as createDiagnosticTraceContext, y as runWithDiagnosticTraceContext } from "./diagnostic-events-CKGnBU6G.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-Bhq-McUP.js";
import { i as runExec } from "./exec-DIR5K8F-.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-BjR_s9m0.js";
import { o as getTailnetHostname } from "./tailscale-BrJY63WE.js";
import { t as isContainerEnvironment } from "./container-environment-DxZhL--1.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-CuPdsPA_.js";
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, g as resolveRequestClientIp, h as resolveHostName, i as isLoopbackHost, l as isValidIPv4, m as resolveGatewayListenHosts, n as isLocalishHost, o as isPrivateOrLoopbackHost, p as resolveGatewayBindHost, r as isLoopbackAddress, t as defaultGatewayBindMode } from "./net-dUoGHCll.js";
import { a as createAuthRateLimiter, i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN } from "./auth-rate-limit-34nzB6-4.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-C6SOW0Rd.js";
import { n as resolveGatewayAuth } from "./auth-resolve-Bc25IEER.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-CKs_R3Vn.js";
import { l as normalizeMainKey } from "./session-key-BSlq04Dw.js";
import { S as resolveDefaultAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-BBUKdu9R.js";
import { H as isPluginLocalInvalidConfigSnapshot, I as asResolvedSourceConfig, R as materializeRuntimeConfig, T as validateConfigObjectWithPlugins, U as shouldAttemptLastKnownGoodRecovery, _ as recoverConfigFromLastKnownGood, c as promoteConfigSnapshotToLastKnownGood, f as readConfigFileSnapshotWithPluginMetadata, g as recoverConfigFromJsonRootSuffix, i as getRuntimeConfig, j as applyConfigOverrides, r as createConfigIO, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-BcjzQKwO.js";
import { n as formatConfigIssueLines, r as formatConfigIssueSummary } from "./issue-format-DMMGB1uA.js";
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-Bgtbceve.js";
import { n as resolveNormalizedAccountEntry, t as resolveAccountEntry } from "./account-lookup-CMCsK99I.js";
import { r as replaceConfigFile } from "./mutate-D-EdwGeB.js";
import "./config-DZli1BwL.js";
import { n as isRestartEnabled } from "./commands.flags-BhE1r2Oq.js";
import { c as buildDeviceAuthPayloadV3, o as gatewayStartupUnavailableDetails, s as buildDeviceAuthPayload } from "./client-D-i9iMPZ.js";
import { n as resolvePreauthHandshakeTimeoutMs } from "./handshake-timeouts-CtE_u6DW.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-CN4YhWy6.js";
import { r as ensureGlobalUndiciEnvProxyDispatcher } from "./undici-global-dispatcher-C5_wU4PI.js";
import { t as rawDataToString } from "./ws-5qfT9MQf.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-DQju26jn.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, s as isDeliverableMessageChannel, t as isBrowserOperatorUiClient, u as normalizeMessageChannel } from "./message-channel-DERYZbI0.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-B-AB1kW_.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-C73VW4c-.js";
import { Dt as validateSecretsResolveParams, J as validateExecApprovalRequestParams, M as validateConnectParams, Ot as validateSecretsResolveResult, Tt as validateRequestFrame, Xr as errorShape, Y as validateExecApprovalResolveParams, Yr as ErrorCodes, bt as validatePluginApprovalRequestParams, q as validateExecApprovalGetParams, t as formatValidationErrors, xt as validatePluginApprovalResolveParams } from "./protocol-Dx1UjGhv.js";
import { a as approvalDecisionLabel, n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage, t as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-rvSfVSqn.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE$1, o as WRITE_SCOPE, r as PAIRING_SCOPE, t as ADMIN_SCOPE } from "./operator-scopes-aB2XeRZX.js";
import "./method-scopes-BfSc6wvG.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-B8iKKC2A.js";
import { r as normalizeControlUiBasePath } from "./control-ui-shared-FOfn7job.js";
import { l as loadAuthProfileStoreWithoutExternalProfiles } from "./store-Bfn5nqAH.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BwrmwWAA.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-bpKldPfV.js";
import "./loader-CiaemmFD.js";
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-BxiXdopW.js";
import { S as createEmptyPluginRegistry, a as getActivePluginRegistry, b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry, x as setActivePluginRegistry } from "./runtime-cXQdYJwN.js";
import { f as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext } from "./agent-events-DiLiL9Ik.js";
import { i as resolveMainSessionKey } from "./main-session-B93p_wMF.js";
import { n as channelRouteDedupeKey } from "./channel-route-gs33uT_o.js";
import { n as getLoadedChannelPluginEntryById } from "./registry-loaded-rqD-zJtH.js";
import { i as listChannelPlugins, n as getLoadedChannelPlugin, r as getLoadedChannelPluginOrigin, t as getChannelPlugin } from "./registry-D_T9eteF.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-DMPVpaLC.js";
import "./sessions-BPG8G_xx.js";
import { c as onSessionTranscriptUpdate } from "./transcript-C_uDP9Gl.js";
import { g as getActiveEmbeddedRunCount } from "./runs-DWPap98a.js";
import { g as stopDiagnosticHeartbeat, h as startDiagnosticHeartbeat } from "./diagnostic-oEUVZa4J.js";
import { l as getTotalQueueSize } from "./command-queue-Bkbt0KSa.js";
import { a as enqueueSystemEvent } from "./system-events-DPTmXPUa.js";
import { r as resolveCronStorePath } from "./store-CVmO9ecP.js";
import { i as getInspectableTaskRegistrySummary, m as stopTaskRegistryMaintenance, p as startTaskRegistryMaintenance, t as configureTaskRegistryMaintenance } from "./task-registry.maintenance-C8YCyY6t.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-FjQuY7rb.js";
import { _ as onSessionLifecycleEvent, c as initSubagentRegistry } from "./subagent-registry-CBg_6tH6.js";
import { n as detectMime } from "./mime-CDoSsIec.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-Dr322o7Y.js";
import { t as getMachineDisplayName } from "./machine-name-WdekediH.js";
import "./auth-profiles-lwt7gXZE.js";
import { D as resolveExecApprovalRequestAllowedDecisions, E as resolveExecApprovalAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-qlTGzHgv.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-Dg2ko22y.js";
import { r as cleanOldMedia } from "./store-ftuzo5rE.js";
import { a as CANVAS_HOST_PATH, n as normalizeUrlPath, r as resolveFileWithinRoot, s as injectCanvasLiveReload, t as handleA2uiHttpRequest } from "./a2ui-CmQv34B6.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-C0FwO_Iu.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-13HIbCz2.js";
import { r as resetDirectoryCache } from "./target-resolver-COIA4oVB.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-qC0srFJg.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CnGkAf9b.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BL621Tti.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-Coz8389x.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-0k4hZAz9.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-B6bNghlQ.js";
import { a as isExecApprovalChannelRuntimeTerminalStartError } from "./approval-native-runtime-Cp97BFcs.js";
import { n as sanitizeExecApprovalDisplayText, r as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-DpcXTwKb.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-DJRGw_h0.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-DI13lbd7.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-DW8qCSRD.js";
import { r as onHeartbeatEvent } from "./heartbeat-events-Duc0AlYm.js";
import { r as registerSkillsChangeListener } from "./refresh-state-RRnSR290.js";
import { a as resolveNodeCommandAllowlist, i as normalizeDeclaredNodeCommands } from "./node-command-policy-DY_FmwkG.js";
import { t as safeParseJson } from "./server-json-oVk3cgfm.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-CfCf9IEq.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-CPwOI9oj.js";
import { l as roleScopesAllow } from "./pairing-token-D_VV8lA7.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-lrjZZOLs.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, i as recordRemoteNodeInfo, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo } from "./skills-remote-FOTXALKo.js";
import { i as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-CgxWfTlI.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-CMJxtqB1.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-DKK__3pB.js";
import { t as createDefaultDeps } from "./deps-BJgtykch.js";
import { i as buildSystemRunApprovalEnvBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-DCljuo3O.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-2JMs3eDm.js";
import { d as logRejectedLargePayload, n as sendGatewayAuthFailure, o as setDefaultSecurityHeaders } from "./http-common-BW6XcwuF.js";
import { _ as resolveHooksConfig } from "./hooks-Diu03-e_.js";
import { n as loadGatewayModelCatalog, t as __resetModelCatalogCacheForTest } from "./server-model-catalog-CzyeR5-a.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, r as HEALTH_REFRESH_INTERVAL_MS, s as TICK_INTERVAL_MS, t as DEDUPE_MAX } from "./server-constants-BLUdHozU.js";
import { t as abortChatRunById } from "./chat-abort-DqrwtdgZ.js";
import "./refresh-JCQQ0xlS.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-7D9YQUAO.js";
import { t as GatewayLockError } from "./gateway-lock-BWTg_mt-.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BRd919lV.js";
import { t as getHealthSnapshot } from "./health-DD8i4PL7.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-Dd8gU2PN.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-Bx_OBZuO.js";
import { t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-CF7kNrRr.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-f1EGD6UX.js";
import { a as createToolEventRecipientRegistry, i as createSessionMessageSubscriberRegistry, n as createChatRunState, r as createSessionEventSubscriberRegistry } from "./server-chat-state-xIpd9Yv0.js";
import { S as roleCanSkipDeviceIdentity, f as loadVoiceWakeConfig, h as loadVoiceWakeRoutingConfig, i as upsertPresence, m as resolveSessionKeyForRun, n as listSystemPresence, s as clearNodeWakeState, t as broadcastPresenceSnapshot, u as formatError, w as pruneStaleControlPlaneBuckets, x as parseGatewayRole } from "./presence-events-Bj1M2eIy.js";
import { i as buildGatewayReloadPlan, t as diffConfigPaths } from "./config-reload-CQVdRI06.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-s_l52H-i.js";
import { i as normalizeCanvasScopedUrl, n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-BqtQAiZK.js";
import { a as mergeActivationSectionsIntoRuntimeConfig, i as setFallbackGatewayContextResolver, t as loadGatewayStartupPlugins } from "./server-plugin-bootstrap-CP5N2GgK.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-IFIyjb16.js";
import { a as getRequiredSharedGatewaySessionGeneration, d as DEFAULT_CHANNEL_CONNECT_GRACE_MS, f as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, g as enqueueConfigRecoveryNotice, h as buildGatewayCronService, i as enforceSharedGatewaySessionGenerationForConfigWrite, m as applyGatewayLaneConcurrency, n as disconnectAllSharedGatewayAuthClients, o as setCurrentSharedGatewaySessionGeneration, p as evaluateChannelHealth, r as disconnectStaleSharedGatewayAuthClients, s as activateGatewayScheduledServices, t as resolveHookClientIpConfig, u as startGatewayRuntimeServices } from "./hook-client-ip-config-CpSzgieT.js";
import { a as resolvePluginRoutePathContext, i as isProtectedPluginRoutePathFromContext, n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-BaNA1Vja.js";
import "./paths-CBoAEKTT.js";
import { t as getUpdateAvailable } from "./update-startup-BUAbuzGc.js";
import { t as hasConfiguredInternalHooks } from "./configured-QeTrLmym.js";
import { t as truncateCloseReason } from "./close-reason-DMG9w-RB.js";
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-BGTFMr5n.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-CVcZU_1o.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-B5nsrWJy.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-DS9UWrt0.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-Cbz2db2V.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-COuN4apV.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-DA77dquf.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-CbCbh7LN.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-BRE9_56j.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-C3H_xDZ6.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-BXfJ0YgG.js");
	return voiceClawRealtimeUpgradeModulePromise;
}
function getCanvasAuthModule() {
	canvasAuthModulePromise ??= import("./http-auth-DMI-FHLh.js");
	return canvasAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-Bk76gRP2.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-CMzmoC2O.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-2LGt31u4.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-Be74xtdZ.js");
...
function startGatewayEventSubscriptions(params) {
	...
	const getAgentEventHandler = () => {
		agentEventHandlerPromise ??= import("./server-chat-CeSx1Sbx.js").then(({ createAgentEventHandler }) => createAgentEventHandler({
			broadcast: params.broadcast,
			broadcastToConnIds: params.broadcastToConnIds,
			nodeSendToSession: params.nodeSendToSession,
			agentRunSeq: params.agentRunSeq,
	...
	const getTranscriptUpdateHandler = () => {
		transcriptUpdateHandlerPromise ??= import("./server-session-events-h3bEaCKO.js").then(({ createTranscriptUpdateBroadcastHandler }) => createTranscriptUpdateBroadcastHandler({
			broadcastToConnIds: params.broadcastToConnIds,
			sessionEventSubscribers: params.sessionEventSubscribers,
	...
	const getLifecycleEventHandler = () => {
		lifecycleEventHandlerPromise ??= import("./server-session-events-h3bEaCKO.js").then(({ createLifecycleEventBroadcastHandler }) => createLifecycleEventBroadcastHandler({
			broadcastToConnIds: params.broadcastToConnIds,
			sessionEventSubscribers: params.sessionEventSubscribers
		}));
...
function scheduleGatewayMemoryBackend(params) {
	...
	const start = () => {
		import("./server-startup-memory-BVtDN6Z2.js").then(({ startGatewayMemoryBackend }) => startGatewayMemoryBackend({
			cfg: params.cfg,
			log: params.log
		})).catch((err) => {
...
async function hasGatewayStartupInternalHookListeners() {
	const { hasInternalHookListeners } = await import("./internal-hooks-D7vAtKAS.js");
	return hasInternalHookListeners("gateway", "startup");
}
async function waitForAcpRuntimeBackendReady(params) {
	const { getAcpRuntimeBackend } = await import("./registry-Cj3r7u8M.js");
...
async function prewarmConfiguredPrimaryModel(params) {
	const { resolveAgentModelPrimaryValue } = await import("./model-input-QmeIx30u.js");
	...
	const [{ resolveOpenClawAgentDir }, { resolveAgentWorkspaceDir, resolveDefaultAgentId }, { DEFAULT_MODEL, DEFAULT_PROVIDER }, { isCliProvider, resolveConfiguredModelRef }, { resolveEmbeddedAgentRuntime }] = await Promise.all([
		import("./agent-paths-CAdPipnC.js"),
		import("./agent-scope-JzdWovLn.js"),
		import("./defaults-DKZsPKqU.js"),
		import("./model-selection-vj2KsHKW.js"),
		import("./runtime-CNEoqg5T.js")
	]);
	...
	const { ensureOpenClawModelsJson } = await import("./models-config-C9ygTgxu.js");
...
async function startGatewaySidecars(params) {
	await measureStartup(params.startupTrace, "sidecars.session-locks", async () => {
		try {
			const [{ resolveStateDir }, { resolveAgentSessionDirs }, { cleanStaleLockFiles }] = await Promise.all([
				...
				import("./session-write-lock-DKDFiDdt.js")
			]);
			...
			for (const sessionsDir of sessionDirs) {
				...
				if (result.cleaned.length > 0) {
					const { markRestartAbortedMainSessionsFromLocks } = await import("./main-session-restart-recovery-BPlV9YuY.js");
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-watch", async () => {
		if (params.cfg.hooks?.enabled && params.cfg.hooks.gmail?.account) {
			const { startGmailWatcherWithLogs } = await import("./gmail-watcher-lifecycle-DVsYtQPH.js");
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-model", async () => {
		if (params.cfg.hooks?.gmail?.model) {
			const [{ DEFAULT_MODEL, DEFAULT_PROVIDER }, { loadModelCatalog }, { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel }] = await Promise.all([
				import("./defaults-DKZsPKqU.js"),
				import("./model-catalog-C6Mkn6Hf.js"),
				import("./model-selection-vj2KsHKW.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.internal-hooks", async () => {
		try {
			if (internalHooksConfigured) {
				const [{ setInternalHooksEnabled }, { loadInternalHooks }] = await Promise.all([import("./internal-hooks-D7vAtKAS.js"), import("./loader-DrxGzVFg.js")]);
	...
	if (internalHooksConfigured || await hasGatewayStartupInternalHookListeners()) setTimeout(() => {
		import("./internal-hooks-D7vAtKAS.js").then(({ createInternalHookEvent, triggerInternalHook }) => {
	...
	await measureStartup(params.startupTrace, "sidecars.plugin-services", async () => {
		try {
			const { startPluginServices } = await import("./services-CTQW_M_S.js");
	...
	if (params.cfg.acp?.enabled) (async () => {
		...
		const [{ getAcpSessionManager }, { ACP_SESSION_IDENTITY_RENDERER_VERSION }] = await Promise.all([import("./manager-DfRmFf-a.js"), import("./session-identifiers-CHx4h8Px.js")]);
	...
	await measureStartup(params.startupTrace, "sidecars.restart-sentinel", async () => {
		...
		const { hasRestartSentinel } = await import("./restart-sentinel-DjoHqD7Z.js");
		if (!await hasRestartSentinel()) return;
		setTimeout(() => {
			import("./server-restart-sentinel-CZ67XaZb.js").then(({ scheduleRestartSentinelWake }) => scheduleRestartSentinelWake({ deps: params.deps })).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.subagent-recovery", async () => {
		const { scheduleSubagentOrphanRecovery } = await import("./subagent-registry-BpW3a1M6.js");
		scheduleSubagentOrphanRecovery();
	});
	await measureStartup(params.startupTrace, "sidecars.main-session-recovery", async () => {
		const { scheduleRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-BPlV9YuY.js");
		scheduleRestartAbortedMainSessionRecovery();
	});
	return { pluginServices };
}
const defaultGatewayPostAttachRuntimeDeps = {
	getGlobalHookRunner: async () => (await import("./hook-runner-global-Die-LGee.js")).getGlobalHookRunner(),
	logGatewayStartup: async (params) => (await import("./server-startup-log-nMATJ8vZ.js")).logGatewayStartup(params),
	refreshLatestUpdateRestartSentinel: async () => (await import("./server-restart-sentinel-CZ67XaZb.js")).refreshLatestUpdateRestartSentinel(),
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-DVHNMJtG.js")).scheduleGatewayUpdateCheck(...args),
	startGatewaySidecars,
	startGatewayTailscaleExposure: async (...args) => (await import("./server-tailscale-Dj7LKqGr.js")).startGatewayTailscaleExposure(...args)
};
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-BDdu1Gof.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-DwLvziAl.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-BqN-u9W5.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-DJJ5mQPl.js");
	await closeMcpLoopbackServer();
}
let gatewayCloseModulePromise = null;
function loadGatewayCloseModule() {
	gatewayCloseModulePromise ??= import("./server-close-DsVPJDIx.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-ClPqryQz.js");
	...
	try {
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-cFt_pYLz.js"),
				import("./server-plugin-bootstrap-BkMb9k4b.js"),
				import("./services-CTQW_M_S.js")
			]);
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-BkMb9k4b.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-QCrtSbVX.js");
