...
import { n as shouldEagerRegisterSubcommands } from "./command-registration-policy-D9jF-Osx.js";
import { t as addGatewayClientOptions } from "./gateway-rpc-CE5tI7Sz.js";
import { t as formatHelpExamples } from "./help-format-Bco0q1mF.js";
import { i as registerCommandGroups } from "./register-command-groups-B90HtxlK.js";
import "./cli-runtime-BJLQTz3d.js";
import "./core-api-CaOGtXVA.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-BGDkqz1j.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-Bl2Kj4CE.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-Ci7gkhnI.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-BOBpkvC7.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-Cas-k0FX.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-C5seNoGP.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
