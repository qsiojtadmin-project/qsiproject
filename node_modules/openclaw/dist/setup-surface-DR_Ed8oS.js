...
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-Yq43-9dM.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-BzhEekT8.js";
...
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-DO0x-B2n.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-BEW6rKrt.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-B8CjfQDe.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-Do9fxEY5.js";
import { t as updateMatrixAccountConfig } from "./config-update-DNXqoBLR.js";
import { n as validateMatrixHomeserverUrl, r as isPrivateOrLoopbackHost, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-Y9QtI0Mc.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-B7t6W45Q.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-DAUxTelL.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-BljiZtvd.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-l7qrgGnP.js");
