...
import { t as resolveCliCommandPathPolicy } from "./command-path-policy-Betibm4e.js";
import { t as resolveCliStartupPolicy } from "./command-startup-policy-DdD01K9p.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-CB7Kde6G.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-B9b-t_tY.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CZJlY6-H.js");
	if (params.argv) {
