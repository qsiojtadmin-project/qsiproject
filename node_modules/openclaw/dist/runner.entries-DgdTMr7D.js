...
import { t as resolveSystemBin } from "./resolve-system-bin-_XOFdOtO.js";
import { t as applyTemplate } from "./templating-ty_aeLlh.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DLlDbWSj.js";
import { t as describeImageWithModel } from "./image-runtime-DTRuE-vY.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-Bc8Phmwd.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-l2VYcg-y.js";
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-CPX5NSIF.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-IcZEVgy9.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-fsacG-5z.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-CWNwL5SS.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-DEO-bprS.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
