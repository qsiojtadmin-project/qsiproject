...
import { a as isSubagentSessionKey, n as isAcpSessionKey, o as parseAgentSessionKey } from "./session-key-utils-B7QL53SS.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-BSlq04Dw.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-BsU85q1D.js";
import { b as resolveAgentDir, g as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-BBUKdu9R.js";
import { i as getRuntimeConfig } from "./io-BcjzQKwO.js";
import "./defaults-Bnf56S7k.js";
import "./config-DZli1BwL.js";
import { a as normalizeAnyChannelId } from "./registry-CmNv8az5.js";
import "./message-channel-core-BPNeOyTS.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-DERYZbI0.js";
import { a as isInterSessionInputProvenance, n as annotateInterSessionPromptText } from "./input-provenance-CYxw9P51.js";
import { C as resetRegisteredAgentHarnessSessions } from "./loader-CiaemmFD.js";
import { l as fireAndForgetHook, t as getGlobalHookRunner } from "./hook-runner-global-BxiXdopW.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BuesQqCh.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-B93p_wMF.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-CZGTKQyN.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-CwrlKsUf.js";
import { c as resolveMaintenanceConfigFromInput, d as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-BIF3vVgu.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-rqD-zJtH.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-D_T9eteF.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-DvgZqAOK.js";
import { d as resolveSessionStoreEntry, m as deriveSessionMetaPatch, o as updateSessionStore, v as resolveGroupSessionKey } from "./store-Cv5z_jxw.js";
import { t as normalizeChatType } from "./chat-type-CoRph74I.js";
import "./plugins-DMPVpaLC.js";
import { s as resolveSessionLifecycleTimestamps } from "./sessions-BPG8G_xx.js";
import { c as resolveSessionResetPolicy, i as resolveThreadFlag, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-C862DSqb.js";
import { n as resolveSessionKey } from "./session-key-ygzpAxS8.js";
import { t as resolveAndPersistSessionFile } from "./session-file-BQ1eV6Lo.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-B6u2OWdP.js";
import { f as normalizeThinkLevel, h as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-Bi9AZdtM.js";
import "./model-selection-DZLznUc9.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-Bkbt0KSa.js";
...
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-B-mjBMYM.js";
import { c as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-DW-_teth.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-BL2axuiI.js";
import "./pi-bundle-mcp-tools-pJzj9H_j.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-DhnGMxkW.js";
import { t as finalizeInboundContext } from "./inbound-context-BsDft3qL.js";
import { r as HEARTBEAT_TRANSCRIPT_PROMPT } from "./heartbeat-hRLx3GO2.js";
...
import { l as ensureAgentWorkspace } from "./workspace-CMeJGaIy.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-TiyRI7gd.js";
...
import { n as resolveChannelGroupRequireMention } from "./group-policy-BE8DrRTa.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-P44RAWI9.js";
import { i as generateSecureToken } from "./secure-random-BDFWIkXV.js";
import { n as resolveSilentReplySettings } from "./silent-reply-xG0JbFBC.js";
import { t as buildOutboundSessionContext } from "./session-context-Cw-xGFXI.js";
import { r as resolveQueueSettings, t as isSteeringQueueMode } from "./queue-y-VPBYRY.js";
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-D_lqfOik.js";
import { a as resolveParentForkDecision, i as forkSessionFromParent } from "./subagent-spawn-Btdu5pK2.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-CfOF7etk.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-BcHaSkb9.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-BCoLarFb.js";
import { t as hasControlCommand } from "./command-detection-BSv7N0_l.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-BXVmWHMe.js";
import "./commands-registry-Cn8HYSQn.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-4UIEP73W.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-DOq4OFcv.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-2eKEMh_m.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-B1Qgdl4N.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-CoORF3mz.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-CPTx_PkL.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-PlTSxDWM.js";
import { t as resolveChannelModelOverride } from "./model-overrides-C9oqNt0R.js";
import { t as normalizeGroupActivation } from "./group-activation-CRq4dbmX.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-Cx16G_w-.js";
import { t as resolveFastModeState } from "./fast-mode-kUuIrawx.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-OoMSt35x.js";
import { t as buildCommandContext } from "./commands-context-BocQ3O4E.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-D4UrOBGu.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-BD-9WU4r.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-Bvddp9G8.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-DEZBtCZV.js";
...
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-YjzTiJXl.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-DBfQ5mOu.js";
import { t as hasInboundMedia } from "./inbound-media-CqgxBlAH.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-CHxl0D4T.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-BadPXIql.js";
import { r as getCliSessionBinding } from "./cli-session-CxuINA04.js";
import { n as resolveResetPreservedSelection, t as clearSessionResetRuntimeState } from "./session-reset-cleanup-7ei3n6tr.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-BsEjY-hk.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-DI_tWEmo.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-DDULf-4L.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-CDtjDrB6.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-D4RKNLMQ.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-CBYTfqwg.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-Dm5-KKSf.js"));
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-CRrcaFXq.js");
...
const hookRunnerGlobalLoader = createLazyImportLoader(() => import("./hook-runner-global-Die-LGee.js"));
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-CBqTiWrE.js"));
