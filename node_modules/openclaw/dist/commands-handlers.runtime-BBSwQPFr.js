...
import { r as logVerbose } from "./globals-CX0Bl8ZU.js";
import { r as normalizeOptionalAccountId } from "./account-id-CKs_R3Vn.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-BSlq04Dw.js";
import { b as resolveAgentDir, p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-BBUKdu9R.js";
import { F as unsetConfigOverride, M as getConfigOverrides, N as resetConfigOverrides, P as setConfigOverride, T as validateConfigObjectWithPlugins, u as readConfigFileSnapshot } from "./io-BcjzQKwO.js";
import { f as resolveArchiveKind } from "./archive-Bcidy6tG.js";
import "./installed-plugin-index-records-8C6k9IGw.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-g7xlhgqz.js";
import { t as setPluginEnabledInConfig } from "./toggle-config--qYsh2ze.js";
...
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-BhE1r2Oq.js";
...
import { r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-DERYZbI0.js";
import { f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart } from "./restart-B8iKKC2A.js";
import { t as getActivePluginChannelRegistry } from "./runtime-cXQdYJwN.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BuesQqCh.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-CZGTKQyN.js";
import { t as loadSessionStore } from "./store-load-BIF3vVgu.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-D_T9eteF.js";
import { o as resolveFreshSessionTotalTokens } from "./types-DvgZqAOK.js";
...
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-C_uDP9Gl.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-B5ieQ54a.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BNtEtbrF.js";
import { g as resolveResponseUsageMode, m as normalizeUsageDisplay } from "./thinking-Bi9AZdtM.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-D2iI3D5p.js";
import { a as getActiveEmbeddedRunSnapshot, y as replyRunRegistry } from "./runs-DWPap98a.js";
import "./diagnostic-oEUVZa4J.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-6i95WBvb.js";
...
import { n as stripInboundMetadata } from "./strip-inbound-meta-BX8nyryk.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-BsmFEyNj.js";
import { r as getSessionBindingService } from "./session-binding-service-BR4UVC3b.js";
import { i as callGateway } from "./call-HHsCuKDy.js";
import { t as formatDurationCompact } from "./format-duration-BtuBEz32.js";
import { r as isSilentReplyPayloadText } from "./tokens-B-mjBMYM.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-Cas9gv0H.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-MCrssume.js";
import { C as setTtsMaxLength, D as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsMaxLength, b as setSummarizationEnabled, c as isSummarizationEnabled, f as listTtsPersonas, g as resolveTtsConfig, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, o as getTtsPersona, r as getLastTtsAttempt, s as getTtsProvider, u as isTtsProviderConfigured, w as setTtsPersona, y as setLastTtsAttempt } from "./tts-runtime-C_xQKyqz.js";
import "./tts-Cm0MRYDz.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-DlUADZXK.js";
import { a as resolveBootstrapMaxChars, s as resolveBootstrapTotalMaxChars } from "./google-BuAT977e.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CmKX6fUV.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-BbbvhMCD.js";
...
import { a as stripToolResultDetails } from "./session-transcript-repair-UKicgybr.js";
...
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-D9pao_xK.js";
import { n as routeReply } from "./route-reply-BmSdPEAz.js";
import { s as clearSessionQueues } from "./queue-y-VPBYRY.js";
import "./sandbox-BULaIO3n.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-D3JTe0id.js";
import { n as estimateTokensFromChars } from "./cjk-chars-BwCZjbDH.js";
import { r as resolveModelWithRegistry } from "./model-BUApK8L3.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-CVKHcrEn.js";
import { t as isApprovalNotFoundError } from "./approval-errors-B8xeH8Cn.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-BcHaSkb9.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-BCoLarFb.js";
...
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-4UIEP73W.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-B1Qgdl4N.js";
import { n as formatTimeAgo } from "./format-relative-DNoVhakg.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-DP4CYJeo.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-jQ5Zc-np.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-Bmy3QPQ8.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-tCbJ24oZ.js";
import { n as parseActivationCommand } from "./group-activation-CRq4dbmX.js";
import { t as resolveFastModeState } from "./fast-mode-kUuIrawx.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-B7x39NJr.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-PMbCotu_.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-BkFIyuJn.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-DBfQ5mOu.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Bv8DWsYK.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-CIPCbQwk.js";
import { t as extractBtwQuestion } from "./btw-command-CAQvRXwf.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-BvwBRQzc.js";
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-BjZLwqR2.js";
import { t as handleAcpCommand } from "./commands-acp-xwxvMRI-.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-Cc1CS4jb.js";
import { v as getFinishedSession, y as getSession } from "./bash-tools.exec-runtime-DtbDrPpX.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-qoJgDxzy.js";
import { r as handleModelsCommand } from "./commands-models-CAXB6CgC.js";
import { r as createExecTool } from "./bash-tools-CwNyLceP.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./task-status-access-B6qhJ_J-.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-CczkGKIv.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-CFkS4nFX.js";
import { t as buildToolsMessage } from "./status-D2Y8yDM6.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-q6MN7wsF.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-Dw-4UKRq.js";
import "./command-export-DLot3vSL.js";
import { t as buildStatusReply } from "./commands-status-DqfbuDL1.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-DMtHWeop.js";
import { a as buildPluginDiagnosticsReport, l as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginRegistrySnapshotReport, t as buildAllPluginInspectReports } from "./status-CObL9KOW.js";
import { r as createPluginInstallLogger, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-dtVGgZut.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-RN5EKPkR.js";
import "./clawhub-3jv5UPiV.js";
import { a as installPluginFromPath, i as installPluginFromNpmSpec } from "./install-BFV9m6JS.js";
import { r as installPluginFromClawHub } from "./clawhub-17S-FTR2.js";
import { n as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-5h1Sxo5W.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-_isynm6f.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-X-tEyf5K.js");
		killProcessTree(pid);
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-1yWtzJZn.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-CcAqDUwM.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-7iTbaLiq.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-CWeTxbdj.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-j0rObT9M.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-C0ap9tSn.js"));
const actionKillLoader = createLazyImportLoader(() => import("./action-kill-Dx7hFnNQ.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-5Z0_uMpU.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-BUUJE7kd.js"));
const actionSendLoader = createLazyImportLoader(() => import("./action-send-c2hHx6iz.js"));
const actionSpawnLoader = createLazyImportLoader(() => import("./action-spawn-DN1Eo9tX.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-CCi4faED.js"));
const controlRuntimeLoader = createLazyImportLoader(() => import("./commands-subagents-control.runtime-CW16QZDo.js"));
