...
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-D-i9iMPZ.js";
...
import { i as READ_SCOPE } from "./operator-scopes-aB2XeRZX.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-D-upsXGv.js");
