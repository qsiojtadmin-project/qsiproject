...
import { t as PLUGIN_REGISTRY_STATE } from "./runtime-state-83zfgPgL.js";
import { l as onAgentEvent } from "./agent-events-DiLiL9Ik.js";
import { i as dispatchPluginAgentEventSubscriptions, n as clearPluginHostRuntimeState } from "./host-hook-runtime-CBr0kxqd.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-DEzenwpE.js")]);
