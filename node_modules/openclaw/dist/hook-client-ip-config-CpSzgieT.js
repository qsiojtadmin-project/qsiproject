...
import { n as isVitestRuntimeEnv } from "./env-DzjAzpl4.js";
...
import { r as isCronRunSessionKey } from "./session-key-utils-B7QL53SS.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-BSlq04Dw.js";
import { S as resolveDefaultAgentId } from "./agent-scope-BBUKdu9R.js";
import { i as getRuntimeConfig } from "./io-BcjzQKwO.js";
import { r as formatConfigIssueSummary } from "./issue-format-DMMGB1uA.js";
import { n as resolveSubagentMaxConcurrent, t as resolveAgentMaxConcurrent } from "./agent-limits-DLaGPWFr.js";
...
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-B93p_wMF.js";
import { u as resolveStorePath } from "./paths-CZGTKQyN.js";
import { t as loadSessionStore } from "./store-load-BIF3vVgu.js";
import { o as updateSessionStore, t as archiveRemovedSessionTranscripts } from "./store-Cv5z_jxw.js";
import "./sessions-BPG8G_xx.js";
import "./logging-DJCGPfPx.js";
import { t as abortAndDrainEmbeddedPiRun } from "./runs-DWPap98a.js";
import { i as enqueueCommandInLane, p as setCommandLaneConcurrency } from "./command-queue-Bkbt0KSa.js";
import { a as isRetryableHeartbeatBusySkipReason, o as requestHeartbeat } from "./heartbeat-wake--JQfCD4C.js";
import { a as enqueueSystemEvent } from "./system-events-DPTmXPUa.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-gQFPyIAC.js";
import { i as markCronJobActive, t as clearCronJobActive } from "./active-jobs-Du_P-ZaK.js";
import { a as resolveCronRunLogPath, o as resolveCronRunLogPruneOptions, t as appendCronRunLog } from "./run-log-BZ_vmLmO.js";
import { a as cronSchedulingInputsEqual, i as saveCronStore, r as resolveCronStorePath, t as loadCronStore } from "./store-CVmO9ecP.js";
import { t as SsrFBlockedError } from "./ssrf-Bh_Tym8T.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-odth2y1P.js";
import { i as isGatewayModelPricingEnabled } from "./model-pricing-cache-CmvDvmzT.js";
import "./session-utils.fs-W0CAUUsv.js";
import { i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-ChpKnvQz.js";
import { o as normalizeCronJobInput } from "./openclaw-tools-BDF6gNXk.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-BCrrEJFL.js";
import { t as deliverOutboundPayloads } from "./deliver-BCtMABIO.js";
import { a as resolveCronNotificationSessionKey, i as resolveCronDeliverySessionKey, o as resolveCronSessionTargetSessionKey, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-_kjIcjLk.js";
import { t as buildOutboundSessionContext } from "./session-context-Cw-xGFXI.js";
import "./pi-embedded-rWtLEwl7.js";
import { n as resolveAgentOutboundIdentity } from "./identity-C3Qnkuza.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-Bsdr_LTi.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-BuOxLuYi.js";
import { n as resolveFailureDestination, t as resolveCronDeliveryPlan } from "./delivery-plan-CrJEr6W5.js";
import { t as runCronIsolatedAgentTurn } from "./isolated-agent-C4WJpsLx.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-BNcNsOxj.js";
import { t as createCronExecutionId } from "./run-id-t9NB-AHR.js";
import { n as resolveGatewayReloadSettings } from "./config-reload-CQVdRI06.js";
import { n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-BHI-wtwo.js";
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-C_e0PJKY.js");
		const { deliverOutboundPayloads } = await import("./deliver-DzHH8jTB.js");
...
function recoverPendingSessionDeliveries(params) {
	setTimeout(() => {
		(async () => {
			const { recoverPendingRestartContinuationDeliveries } = await import("./server-restart-sentinel-CZ67XaZb.js");
...
function startGatewayModelPricingRefreshOnDemand(params) {
	...
	let stopRefresh;
	(async () => {
		const { startGatewayModelPricingRefresh } = await import("./model-pricing-cache-CjcGRxFy.js");
		if (stopped) return;
