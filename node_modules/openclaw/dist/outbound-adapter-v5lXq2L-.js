...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-8wTXlIug.js";
import { n as resolveOutboundSendDep } from "./send-deps-jTRjIYIm.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-DItSp-Uy.js";
...
import { a as chunkDiscordTextWithMode, i as normalizeDiscordOutboundTarget } from "./normalize-CNqonV1l.js";
import { p as DiscordError } from "./discord-Cv2PBeIv.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-CPa8NiRB.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-DD2EsG6A.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-7zZ-sQXg.js");
