...
import { u as isPrivateIpAddress } from "./ssrf-Bh_Tym8T.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-BxG5HEpf.js";
import "./ssrf-runtime-B8FMdlKm.js";
import { t as getMSTeamsRuntime } from "./runtime-api-DXqJ2cxd.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-GTevJLvr.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-C-mBIidr.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-DMZOLLuZ.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-CxCNUUQG.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-qitQV0pT.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
