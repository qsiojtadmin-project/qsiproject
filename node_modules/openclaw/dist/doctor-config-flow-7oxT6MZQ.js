...
import { n as normalizeAccountId, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-CKs_R3Vn.js";
import { T as validateConfigObjectWithPlugins, k as migrateLegacySecretRefEnvMarkers, z as resolveNormalizedProviderModelMaxTokens } from "./io-BcjzQKwO.js";
import { n as formatConfigIssueLines } from "./issue-format-DMMGB1uA.js";
import { r as normalizeTalkSection } from "./talk-Beh_Hxxf.js";
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-Di2LIL8m.js";
import { t as getBootstrapChannelPlugin } from "./bootstrap-registry-DJ6Dp-iG.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-0E7xDprG.js";
import { n as getLoadedChannelPlugin } from "./registry-D_T9eteF.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-DK3pJEmN.js";
import { i as listRouteBindings } from "./bindings-C_6djqHo.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-D-cG-TLI.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-BC0oZOzr.js";
import { t as note } from "./note-DRD-CqSh.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-B6g0W09w.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, n as LEGACY_CONFIG_MIGRATIONS, o as loadBundledChannelDoctorContractApi, r as migrateLegacyWebSearchConfig, s as applyPluginDoctorCompatibilityMigrations } from "./legacy-config-issues-Bce7-rlH.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-Bv_dAOe4.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-Cqv8YaId.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-C6BMLvaH.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-CQASNtMZ.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-qy6bw14s.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-Dz4u2vmO.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-iDkLMNJF.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-BOoeHyTK.js");
		emitDoctorNotes({
			note,
