...
import { Y as prepareProviderExtraParams, Z as resolveProviderExtraParamsForTransport, et as wrapProviderStreamFn } from "./provider-runtime-B5ieQ54a.js";
import { _ as modelKey, g as legacyModelKey } from "./model-selection-shared-B6u2OWdP.js";
import { l as resolveProviderRequestPolicyConfig } from "./provider-request-config-CPX5NSIF.js";
import { t as log } from "./logger-DXbWbpA5.js";
import { f as createOpenAIStringContentWrapper, n as createOpenRouterSystemCacheWrapper, u as createOpenAIResponsesContextManagementWrapper, v as createMinimaxThinkingDisabledWrapper } from "./proxy-stream-wrappers-Bco6m6B3.js";
import { g as streamWithPayloadPatch } from "./provider-model-shared-Cu3necQt.js";
import { i as createGoogleThinkingPayloadWrapper, k as resolveAnthropicCacheRetentionFamily } from "./provider-stream-shared-BF5MzTUo.js";
...
function applyDefaultOpenAIGptRuntimeParams(params, merged) {
	...
	if (params.provider === "openai" && !Object.hasOwn(merged, "transport")) merged.transport = "sse";
