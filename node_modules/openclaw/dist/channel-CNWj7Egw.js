...
import { a as createActionGate } from "./common-Rq2JD8YM.js";
import { c as normalizeMessagePresentation, u as renderMessagePresentationFallbackText } from "./payload-DKHyAa71.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-D9pao_xK.js";
import "./text-runtime-BDbNycHL.js";
import { n as describeAccountSnapshot } from "./account-helpers-Dcsr8uwV.js";
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-BDe4UCri.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-CTiKRfVl.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-Yq43-9dM.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Dhng7tBz.js";
...
import "./account-resolution-FO8cItCH.js";
...
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-DEU1xQNQ.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-D3ORRxSD.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-NsUs9S_F.js";
import "./card-interaction-BPeIBVaE.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-CGvEGh9D.js";
import { t as messageActionTargetAliases } from "./security-audit-DqrwKDKU.js";
import { a as resolveFeishuGroupToolPolicy } from "./policy-BCoJEKYa.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-BV59rTiG.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-B-HwoJNM.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-hyaVjwby.js";
...
async function runScanToCreate(prompter) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-mLbEH82k.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-mLbEH82k.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, configured }) => {
			...
			if (configured && resolvedCredentials) try {
				const { probeFeishu } = await import("./probe-BlWt_gxx.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-TAKd3qrL.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-Dw7O4Dod.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-Uae0FG0O.js");
