...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-Bri0f6hC.js";
...
import { n as openUrl } from "./browser-open-BtRk_aP_.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-B3k18xzs.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-CxlLrZMP.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-DGDlPMR-.js";
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-B4eO7S0F.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-BpB-dbJk.js");
