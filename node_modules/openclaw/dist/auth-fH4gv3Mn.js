...
import { S as resolveDefaultAgentId, b as resolveAgentDir, x as resolveAgentWorkspaceDir } from "./agent-scope-BBUKdu9R.js";
import { t as parseDurationMs } from "./parse-duration-BVBpwr_t.js";
import { s as loadAuthProfileStoreForRuntime } from "./store-Bfn5nqAH.js";
import { n as resolvePluginProviders } from "./providers.runtime-BVTNbiXq.js";
import "./model-selection-shared-B6u2OWdP.js";
...
import { n as clearAuthProfileCooldown } from "./usage-BjRlG_-T.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-CENqxFzU.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-Ckekmzda.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-C9dOnOuw.js";
import { t as createClackPrompter } from "./clack-prompter-Cs0pGj6v.js";
import { n as logConfigUpdated } from "./logging-DlGNLung.js";
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-CpWQai_E.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-DGDlPMR-.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-BeiBkYnh.js";
import { t as isRemoteEnvironment } from "./remote-env-DssKQj_c.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-Nqe-OK2G.js");
				await openUrl(url);
			},
