...
import { n as resolveAgentModelPrimaryValue } from "./model-input-uXpHvROZ.js";
...
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-Bfn5nqAH.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-D8pp5pMx.js";
import { r as loadModelCatalog } from "./model-catalog-Cl9-8vZQ.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-dtwVdL8S.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-HHsCuKDy.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-Bc8Phmwd.js";
import { a as getImageMetadata } from "./image-ops-BG4oRyrk.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-CDoSsIec.js";
import { D as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-C_xQKyqz.js";
...
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-QVGHfyAm.js";
import { t as resolveMemorySearchConfig } from "./memory-search-C4651Mqm.js";
import { r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-64AhdwN0.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-BaO8JXSL.js";
import { n as runCommandWithRuntime } from "./cli-utils-BCrh4eAL.js";
import { t as removeCommandByName } from "./command-tree-B2vuO65z.js";
import { t as collectOption } from "./helpers-c-pJVwMy.js";
import { a as transcribeAudioFile, n as describeImageFileWithModel, r as describeVideoFile, t as describeImageFile } from "./runtime-D41H6A88.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-Dh5Vd7QR.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-DGWDrDUn.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-BsH345Xr.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-fH4gv3Mn.js");
