...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-B5ieQ54a.js";
import "./model-selection-DZLznUc9.js";
import { n as isGoogleModelApi, t as isGemma4ModelRequiringReasoningStrip } from "./google-BuAT977e.js";
import { t as log$1 } from "./logger-DXbWbpA5.js";
import { k as shouldPreserveThinkingBlocks } from "./provider-model-shared-Cu3necQt.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-jTfvSesX.js");
