...
import { t as require_src } from "./src-DcAP2TL9.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-Coh0zHtN.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-BwiKmjEz.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-pZ_4V0tw.js";
import { l as toRatio, n as decodeString } from "./Util-B0QB1njc.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CMuoLykH.js";
import { t as APEv2Parser } from "./APEv2Parser-DkGhnfnH.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DwLEOiVe.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-BRSbCxC5.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-CMOa9lWb.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-Nh-FWtzT.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-CBkIPbsv.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-D6j_zf0l.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-Cy_sW7WB.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-BB_4dxle.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-DwIw6yYu.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-Cg91zoZg.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BKrutQN7.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-Bh9JZjev.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-vg_UF5HY.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BSAGD1kA.js")).WaveParser;
	}
};
//#endregion
