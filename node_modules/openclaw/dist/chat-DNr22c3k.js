...
import { p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-BBUKdu9R.js";
...
import { n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-DERYZbI0.js";
import { C as validateChatSendParams, S as validateChatInjectParams, Xr as errorShape, Yr as ErrorCodes, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-Dx1UjGhv.js";
import { o as normalizeInputProvenance } from "./input-provenance-CYxw9P51.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-aB2XeRZX.js";
import "./method-scopes-BfSc6wvG.js";
import { i as resolveSessionFilePath } from "./paths-CZGTKQyN.js";
import "./sessions-BPG8G_xx.js";
import { o as appendSessionTranscriptMessage, s as emitSessionTranscriptUpdate } from "./transcript-C_uDP9Gl.js";
...
import { a as safeFileURLToPath, t as assertNoWindowsNetworkPath } from "./local-file-access-kTP7-f4T.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-BNXLKYs7.js";
import { C as jsonUtf8Bytes, h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes } from "./session-utils.fs-W0CAUUsv.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-BBgnBiTv.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-C-HfEk7V.js";
import { a as normalizeReplyPayloadsForDelivery } from "./deliver-BCtMABIO.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-8wTXlIug.js";
import { i as deleteMediaBuffer, l as saveMediaBuffer, t as MEDIA_MAX_BYTES } from "./store-ftuzo5rE.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-B8VEw794.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-BULaIO3n.js";
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-BeAvV_hJ.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-C-Pb_IcK.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-qvEfkoBF.js";
...
import { u as logLargePayload } from "./http-common-BW6XcwuF.js";
import { t as augmentChatHistoryWithCliSessionImports } from "./cli-session-history-LsQkXHb9.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-BY3BzuJV.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-DCCs4bgq.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-BLUdHozU.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-CW3lorQh.js";
import { n as isChatStopCommandText, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-DqrwtdgZ.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-DHgdOyea.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-s3UYYaDf.js";
