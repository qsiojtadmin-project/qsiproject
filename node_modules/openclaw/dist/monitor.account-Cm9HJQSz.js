...
import { t as safeEqualSecret } from "./secret-equal-Bjkegyf6.js";
...
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-8wTXlIug.js";
...
import { t as createReplyPrefixContext } from "./reply-prefix-BhKobFgI.js";
...
import { c as resolveOpenDmAllowlistAccess } from "./dm-policy-shared-DWIVwcJt.js";
import "./reply-history-fX9ql_9i.js";
import { r as logTypingFailure } from "./logging-CNsTmISm.js";
import { n as createChannelPairingController } from "./channel-pairing-VB8Jg_fn.js";
import "./webhook-ingress-ieX8Lx9K.js";
import { i as installRequestBodyLimitGuard } from "./http-body-DfbPjFcc.js";
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-231Je4fd.js";
...
import { t as buildAgentMediaPayload } from "./agent-media-payload-BvWVwIMr.js";
import { n as resolveAgentOutboundIdentity } from "./identity-C3Qnkuza.js";
import "./outbound-runtime-Bz1q1EZO.js";
import "./ssrf-runtime-B8FMdlKm.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-CzXC6_8l.js";
...
import { n as createPersistentDedupe } from "./persistent-dedupe-MawS9eIi.js";
import { t as buildFeishuConversationId } from "./conversation-id-DEU1xQNQ.js";
import { i as resolveReceiveIdType } from "./targets-D3ORRxSD.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-B3H7Kh6D.js";
import { _ as readString$2, b as normalizeCommentFileType, d as encodeQuery, f as extractReplyText, g as parseCommentContentElements, h as normalizeString, l as resolveFeishuRuntimeAccount, m as isRecord$2, y as buildFeishuCommentTarget } from "./accounts-NsUs9S_F.js";
import { i as decodeFeishuCardAction, n as buildFeishuCardActionTextFallback, r as createFeishuCardInteractionEnvelope } from "./card-interaction-BPeIBVaE.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-BCoJEKYa.js";
import { t as getFeishuRuntime } from "./runtime-BVg3QiLL.js";
import { a as createEventDispatcher, c as getFeishuUserAgent, o as createFeishuClient, s as createFeishuWSClient, u as require_lib } from "./client-2F5iEQKG.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-B5rN3GBi.js";
import "./runtime-api-Bk9ZaO37.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as sendMediaFeishu, h as downloadMessageResourceFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as isFeishuGroupChatType, n as getMessageFeishu, p as isMentionForwardRequest, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent } from "./send-B_XnF4pW.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-BT1TQ7Mc.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-Bh0dIdA4.js";
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-Cw3Mvdrm.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-1N-vlmlo.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-1N-vlmlo.js");
