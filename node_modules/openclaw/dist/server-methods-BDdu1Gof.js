...
import { t as createSubsystemLogger } from "./subsystem-Bhq-McUP.js";
import { a as logWarn, t as logDebug } from "./logger-D0xgIYk9.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-BjR_s9m0.js";
import "./auth-C6SOW0Rd.js";
import { t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-Bc25IEER.js";
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, n as isAcpSessionKey, o as parseAgentSessionKey, s as parseRawSessionConversationRef } from "./session-key-utils-B7QL53SS.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-CKs_R3Vn.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-BSlq04Dw.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-BsU85q1D.js";
import { S as resolveDefaultAgentId, _ as listAgentIds, b as resolveAgentDir, g as listAgentEntries, p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-BBUKdu9R.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-BcjzQKwO.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-H8HAlurL.js";
import { n as formatConfigIssueLines } from "./issue-format-DMMGB1uA.js";
import { t as applyMergePatch } from "./merge-patch-vE_MJoEo.js";
import { r as DEFAULT_PROVIDER } from "./defaults-Bnf56S7k.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-Beh_Hxxf.js";
import { h as resolveRuntimeConfigCacheKey } from "./runtime-snapshot-Bgtbceve.js";
...
import { o as gatewayStartupUnavailableDetails } from "./client-D-i9iMPZ.js";
import { r as setSafeTimeout } from "./timer-delay-CTX0hSr0.js";
import { a as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity } from "./device-identity-CN4YhWy6.js";
import { a as hasGatewayClientCap, n as GATEWAY_CLIENT_IDS, t as GATEWAY_CLIENT_CAPS } from "./client-info-DQju26jn.js";
import { i as isInternalNonDeliveryChannel } from "./message-channel-core-BPNeOyTS.js";
import { c as isGatewayMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-DERYZbI0.js";
import { $ as validateExecApprovalsSetParams, $t as validateSkillsSearchParams, A as validateConfigSchemaParams, At as validateSessionsAbortParams, B as validateDevicePairApproveParams, Bt as validateSessionsListParams, Cn as validateWebPushUnsubscribeParams, Ct as validatePollParams, D as validateConfigPatchParams, Dn as validateWizardStartParams, E as validateConfigGetParams, En as validateWizardNextParams, F as validateCronRemoveParams, Ft as validateSessionsCompactionListParams, G as validateDeviceTokenRotateParams, Gt as validateSessionsPreviewParams, H as validateDevicePairRejectParams, Ht as validateSessionsMessagesUnsubscribeParams, I as validateCronRunParams, It as validateSessionsCompactionRestoreParams, Jt as validateSessionsSendParams, Kt as validateSessionsResetParams, L as validateCronRunsParams, Lt as validateSessionsCreateParams, Mt as validateSessionsCompactParams, N as validateCronAddParams, Nt as validateSessionsCompactionBranchParams, O as validateConfigSchemaLookupParams, On as validateWizardStatusParams, P as validateCronListParams, Pt as validateSessionsCompactionGetParams, Q as validateExecApprovalsNodeSetParams, Qt as validateSkillsInstallParams, R as validateCronStatusParams, Rt as validateSessionsDeleteParams, Sn as validateWebPushTestParams, St as validatePluginsUiDescriptorsParams, T as validateConfigApplyParams, Tn as validateWizardCancelParams, U as validateDevicePairRemoveParams, Ut as validateSessionsPatchParams, V as validateDevicePairListParams, Vt as validateSessionsMessagesSubscribeParams, W as validateDeviceTokenRevokeParams, Wt as validateSessionsPluginPatchParams, X as validateExecApprovalsGetParams, Xr as errorShape, Xt as validateSkillsBinsParams, Yr as ErrorCodes, Yt as validateSessionsUsageParams, Z as validateExecApprovalsNodeGetParams, Zt as validateSkillsDetailParams, _ as validateChannelsStatusParams, _n as validateUpdateStatusParams, _t as validateNodePendingEnqueueParams, a as validateAgentsCreateParams, an as validateTalkRealtimeRelayAudioParams, bn as validateWebLoginWaitParams, c as validateAgentsFilesListParams, cn as validateTalkRealtimeRelayToolResultParams, ct as validateNodeListParams, d as validateAgentsUpdateParams, dn as validateTalkSpeakParams, dt as validateNodePairRejectParams, en as validateSkillsStatusParams, et as validateLogsTailParams, f as validateArtifactsDownloadParams, ft as validateNodePairRemoveParams, g as validateChannelsStartParams, gn as validateUpdateRunParams, gt as validateNodePendingDrainParams, h as validateChannelsLogoutParams, hi as COMMAND_DESCRIPTION_MAX_LENGTH, hn as validateToolsInvokeParams, ht as validateNodePendingAckParams, i as validateAgentWaitParams, in as validateTalkModeParams, it as validateNodeEventParams, j as validateConfigSetParams, jt as validateSessionsCleanupParams, k as validateConfigSchemaLookupResult, kt as validateSendParams, l as validateAgentsFilesSetParams, ln as validateTalkRealtimeSessionParams, lt as validateNodePairApproveParams, m as validateArtifactsListParams, mn as validateToolsEffectiveParams, mt as validateNodePairVerifyParams, n as validateAgentIdentityParams, nn as validateTalkConfigParams, nt as validateModelsListParams, o as validateAgentsDeleteParams, on as validateTalkRealtimeRelayMarkParams, ot as validateNodeInvokeParams, p as validateArtifactsGetParams, pn as validateToolsCatalogParams, pt as validateNodePairRequestParams, qt as validateSessionsResolveParams, r as validateAgentParams, rt as validateNodeDescribeParams, s as validateAgentsFilesGetParams, sn as validateTalkRealtimeRelayStopParams, st as validateNodeInvokeResultParams, t as formatValidationErrors, tn as validateSkillsUpdateParams, tt as validateMessageActionParams, u as validateAgentsListParams, ut as validateNodePairListParams, v as validateChannelsStopParams, vn as validateWakeParams, w as validateCommandsListParams, wn as validateWebPushVapidPublicKeyParams, wt as validatePushTestParams, xn as validateWebPushSubscribeParams, yn as validateWebLoginStartParams, yt as validateNodeRenameParams, z as validateCronUpdateParams, zt as validateSessionsDescribeParams } from "./protocol-Dx1UjGhv.js";
import { n as annotateInterSessionPromptText, o as normalizeInputProvenance } from "./input-provenance-CYxw9P51.js";
import { t as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-rvSfVSqn.js";
import { a as TALK_SECRETS_SCOPE, t as ADMIN_SCOPE$1 } from "./operator-scopes-aB2XeRZX.js";
import { n as authorizeOperatorScopesForMethod } from "./method-scopes-BfSc6wvG.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-B8iKKC2A.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-FOfn7job.js";
import { n as ensureAuthProfileStore } from "./store-Bfn5nqAH.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-bpKldPfV.js";
import { h as patchPluginSessionExtension } from "./loader-CiaemmFD.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-Rq8c27qg.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-DSR9qn9t.js";
import { a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-cXQdYJwN.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-BuesQqCh.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-DiLiL9Ik.js";
import { d as isPluginJsonValue } from "./host-hook-runtime-CBr0kxqd.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-B93p_wMF.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CBrgXjlz.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-CZGTKQyN.js";
import { h as stringifyRouteThreadId } from "./channel-route-gs33uT_o.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-CwrlKsUf.js";
import { t as loadSessionStore } from "./store-load-BIF3vVgu.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-D_T9eteF.js";
import { n as mergeSessionEntry } from "./types-DvgZqAOK.js";
import { o as updateSessionStore } from "./store-Cv5z_jxw.js";
import "./plugins-DMPVpaLC.js";
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-BPG8G_xx.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-C862DSqb.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-T_hwUEur.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-DkOuNyXa.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-D0x4hHVV.js";
import { d as normalizeReasoningLevel, f as normalizeThinkLevel } from "./thinking-Bi9AZdtM.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CqELRWKM.js";
import { h as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-DWPap98a.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-3pVNvn2t.js";
import { t as detectRespawnSupervisor } from "./supervisor-markers-JyUvdUAZ.js";
import { i as formatDoctorNonInteractiveHint, p as writeRestartSentinel } from "./restart-sentinel-DQ_sBkf5.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DthSW-9A.js";
import { c as setHeartbeatsEnabled } from "./heartbeat-wake--JQfCD4C.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-DPTmXPUa.js";
import { t as extractToolPayload } from "./tool-payload-CkSaO1mJ.js";
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-gQFPyIAC.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-BZ_vmLmO.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-BGcKWhbI.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-MN-JZIlL.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-D9CRirqH.js";
import { n as resolveAgentIdentity } from "./identity-BMoXQgIH.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-CfJA13Af.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-W0CAUUsv.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-ChpKnvQz.js";
...
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-CijL7ekG.js";
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools-BDF6gNXk.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-BJoGiMYD.js";
import { D as textToSpeech, E as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, f as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-C_xQKyqz.js";
import "./tts-Cm0MRYDz.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-CMeJGaIy.js";
import { i as resolveSandboxConfigForAgent } from "./config-CvStoyb5.js";
import { a as isTimeoutError } from "./failover-error-BCrrEJFL.js";
import "./auth-profiles-lwt7gXZE.js";
import { t as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-DTkiOzpl.js";
import { c as projectOutboundPayloadPlanForMirror, n as createOutboundPayloadPlan, t as deliverOutboundPayloads } from "./deliver-BCtMABIO.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-qlTGzHgv.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-Dg2ko22y.js";
import { i as parseAbsoluteTimeMs } from "./stagger-CHWUJ2u5.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-_kjIcjLk.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-B_qWBF4F.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-DdAlzlcs.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-Dk54BbWF.js";
import { n as normalizePollInput } from "./polls-CUKwwi0E.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-Btzyl1gy.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CAx9II92.js";
import "./target-resolver-COIA4oVB.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-BzGkPO6N.js";
import { i as resolveReplyToMode } from "./reply-threading-BF1ajP27.js";
import { t as buildOutboundSessionContext } from "./session-context-Cw-xGFXI.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-qC0srFJg.js";
import { n as validateTargetProviderPrefix, t as resolveTargetPrefixedChannel } from "./channel-target-prefix-D9f8pzKE.js";
import { r as resolveOutboundTarget } from "./targets-BTHYYIiT.js";
import { s as clearSessionQueues } from "./queue-y-VPBYRY.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-C2SSBFIu.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-D_lqfOik.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-Dktak15t.js";
import "./skills-f1xjPdqK.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-Bpg6SC5v.js";
import { n as compactEmbeddedPiSession } from "./pi-embedded-rWtLEwl7.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-g_bdsupJ.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-CVKHcrEn.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-DNiVJfA3.js";
import "./commands-registry-Cn8HYSQn.js";
import { n as resolveSendPolicy } from "./send-policy-BFj7Ll8x.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-64AhdwN0.js";
import { t as getChannelActivity } from "./channel-activity-DuO3W0LG.js";
import { t as WizardCancelledError } from "./prompts-DXTRjBmP.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-BBmQDsyD.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Bv8DWsYK.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-DQAdbyDb.js";
import { t as movePathToTrash } from "./browser-trash-BVsQOz2d.js";
import "./browser-maintenance-BsEjY-hk.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-Duc0AlYm.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-DFmMfnZy.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-DAj5rVMa.js";
import { r as agentCommandFromIngress } from "./agent-command-8dyhOE2t.js";
import { a as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-DY_FmwkG.js";
import { t as safeParseJson } from "./server-json-oVk3cgfm.js";
import { t as formatForLog } from "./ws-log-CfCf9IEq.js";
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-X6e0Mkl8.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-B43Msf3I.js";
import { t as canExecRequestNode } from "./exec-defaults-BsFhezUi.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-C1lVaaiX.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-lrjZZOLs.js";
import { t as getRemoteSkillEligibility } from "./skills-remote-FOTXALKo.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-qoJgDxzy.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-Df0lMiTf.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-CMJxtqB1.js";
import { b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, i as getRealtimeVoiceProvider, n as resolveConfiguredRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession } from "./session-runtime-BaE7xj65.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-Cu06OiWw.js";
import { n as createOutboundSendDeps } from "./deps-BJgtykch.js";
import "./agent-DLmKOn78.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-DCljuo3O.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-2JMs3eDm.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-DVh838p6.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-D_k-YtWm.js";
import "./server-constants-BLUdHozU.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-DNr22c3k.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController } from "./chat-abort-DqrwtdgZ.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-DHgdOyea.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-DYcwaTdC.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-DwoxjoWA.js";
import { t as loadProviderUsageSummary } from "./provider-usage-BQfovYaW.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-B6qhJ_J-.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-3jv5UPiV.js";
import { a as loadSessionUsageTimeSeries, i as loadSessionLogs, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-_isynm6f.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-EZuQgRC5.js";
import { a as performGatewaySessionReset } from "./session-reset-service-_XaBHiaS.js";
import { t as buildChannelUiCatalog } from "./catalog-CrRAKVxi.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-Dh5Vd7QR.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-Dm1YBMh7.js";
import { t as readConfiguredLogTail } from "./log-tail-BnNzWJKb.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DMn1BHBV.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-Kq0u2xwE.js";
import { t as buildChannelAccountSnapshot } from "./status-D7NiPJMK.js";
import { t as installSkill } from "./skills-install-B8f-NNB2.js";
import { m as normalizeUpdateChannel } from "./update-check-BhR_NBlh.js";
import { n as readPackageVersion } from "./package-json-DsQmPQSS.js";
import { t as getStatusSummary } from "./status.summary-DM_sRIaG.js";
import "./status-DElJ1QGL.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-CU-ba-cR.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-DXN2t6wW.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-CyL1lX3L.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-CrJEr6W5.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-BNcNsOxj.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-f1EGD6UX.js";
import { C as consumeControlPlaneWriteBudget, _ as resolveVoiceWakeRouteByTrigger, a as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, b as isRoleAuthorizedForMethod, c as nodeWakeById, d as normalizeVoiceWakeTriggers, f as loadVoiceWakeConfig, g as normalizeVoiceWakeRoutingConfig, h as loadVoiceWakeRoutingConfig, l as nodeWakeNudgeById, m as resolveSessionKeyForRun, n as listSystemPresence, o as NODE_WAKE_RECONNECT_WAIT_MS, p as setVoiceWakeTriggers, r as updateSystemPresence, t as broadcastPresenceSnapshot, u as formatError$1, v as setVoiceWakeRoutingConfig, x as parseGatewayRole, y as validateVoiceWakeRoutingConfigInput } from "./presence-events-Bj1M2eIy.js";
import { i as buildGatewayReloadPlan, n as resolveGatewayReloadSettings, t as diffConfigPaths } from "./config-reload-CQVdRI06.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-s_l52H-i.js";
import { n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-BqtQAiZK.js";
import "./heartbeat-runner-BHI-wtwo.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-2q16N9CI.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-C5WSX2gL.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DYnRr1QW.js");
