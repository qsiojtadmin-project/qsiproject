...
import { n as formatZonedTimestamp } from "./format-datetime-z2eqUO7d.js";
...
import { i as resolveMatrixAccount } from "./accounts-BEW6rKrt.js";
import { t as formatMatrixErrorMessage } from "./errors-Cd78wLHY.js";
import { n as resolveMatrixConfigPath } from "./config-paths-Do9fxEY5.js";
import { t as updateMatrixAccountConfig } from "./config-update-DNXqoBLR.js";
import { n as matrixSetupAdapter } from "./setup-core-D8cU5fB7.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-DpjlG9BB.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BSEGs0Gv.js";
import { t as withResolvedActionClient } from "./client-TnKlIWPR.js";
import { r as resolveMatrixAuthContext } from "./config-CYWBSYwy.js";
import "./client-DgKJzAkZ.js";
import "./runtime-api-DlLGGNsd.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-C-WUhMFO.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-CVCNxawK.js";
import { a as confirmMatrixVerificationSas, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as runMatrixSelfVerification, h as restoreMatrixRoomKeyBackup, l as getMatrixVerificationSas, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, p as requestMatrixVerification, r as cancelMatrixVerification, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as startMatrixVerification, y as verifyMatrixRecoveryKey } from "./verification-DNtz9iX2.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-DvsqPEmA.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-BpU8QauT.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-l7qrgGnP.js");
