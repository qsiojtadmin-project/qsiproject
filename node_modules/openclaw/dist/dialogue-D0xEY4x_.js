import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-CcAJAuqB.js";
import { r as loadCrestodianOverview } from "./overview-Bz6wtPVT.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant--cJ3gHIY.js")).planCrestodianCommand)({
		input,
		overview
	});
