import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-DgUjjQk1.js";
import { i as resolveCodexAppServerRuntimeOptions } from "./config-Byx-Hw_Q.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-DfRnzwyg.js";
import { r as readModelListResult } from "./models-BS0sdaiX.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-BcT9SZ7U.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
