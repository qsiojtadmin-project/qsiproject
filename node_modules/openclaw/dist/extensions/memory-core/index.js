...
import { l as jsonResult } from "../../common-Rq2JD8YM.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-BLimwivT.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-CJF5e-qr.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-BWIduS0s.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-CQ-gl5bA.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-CXvvW_IA.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-BnLHdCDu.js");
				return await handleDreamingCommand(api, ctx);
			}
		});
		api.registerCli(async ({ program }) => {
			const { registerMemoryCli } = await import("../../cli-A84sFaRL.js");
