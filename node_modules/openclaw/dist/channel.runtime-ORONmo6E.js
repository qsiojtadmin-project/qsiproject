...
import { a as createFixedWindowRateLimiter, r as WEBHOOK_RATE_LIMIT_DEFAULTS } from "./webhook-ingress-ieX8Lx9K.js";
import { a as createWebhookInFlightLimiter, c as readWebhookBodyOrReject } from "./webhook-request-guards-231Je4fd.js";
import { t as normalizeWebhookPath } from "./webhook-path-DPn0UMB7.js";
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-BgDQoASz.js";
import "./security-runtime-D35m9RFX.js";
import "./string-coerce-runtime-BeK4jl1z.js";
import { F as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-CU7JCqUT.js";
import { t as getBlueBubblesRuntime } from "./runtime-TLjElgwc.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-BpJAzGVx.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-B7Cu96YT.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-CNUCW1ur.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-CISyfVP0.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
