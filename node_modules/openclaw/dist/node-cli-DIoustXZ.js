...
import { a as decodeWindowsOutputBuffer, o as resolveWindowsConsoleEncoding } from "./windows-command-DKwG4uVK.js";
...
import { A as unwrapKnownShellMultiplexerInvocation, L as unwrapKnownDispatchWrapperInvocation, N as resolveInlineCommandMatch, O as isShellWrapperInvocation, P as extractEnvAssignmentKeysFromDispatchWrappers, R as normalizeExecutableToken, S as POSIX_SHELL_WRAPPERS, d as resolveApprovalAuditCandidatePath, j as POSIX_INLINE_COMMAND_FLAGS, k as resolveShellWrapperTransportArgv, p as resolveCommandResolutionFromArgv, y as resolveExecutableFromPathEnv } from "./exec-safe-bin-trust-BozNgDpi.js";
import "./config-DZli1BwL.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-DokYJ1Jk.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-EBOa8cMc.js";
import { t as parsePort } from "./parse-port-BiGxBMDp.js";
import { n as GatewayClient } from "./client-D-i9iMPZ.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-C73VW4c-.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-CBMp8DOa.js";
import { a as getActivePluginRegistry } from "./runtime-cXQdYJwN.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-Z3xVEsJK.js";
import { t as getMachineDisplayName } from "./machine-name-WdekediH.js";
import { t as splitShellArgs } from "./shell-argv-BizYfNHO.js";
import { _ as resolvePlannedSegmentArgv, c as describeInterpreterInlineEval, d as analyzeArgvCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-BgK6Z8wx.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-pAMpXFVi.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-DPVXGvNR.js";
import { t as formatHelpExamples } from "./help-format-Bco0q1mF.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-DCljuo3O.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-ClcaXsPn.js";
import { t as resolveNodeService } from "./node-service-CAPBzWnK.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-BXJf-Prm.js");
