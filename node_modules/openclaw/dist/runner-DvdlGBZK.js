...
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CSqDnJ4r.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DLlDbWSj.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-Bc8Phmwd.js";
import { t as providerSupportsCapability } from "./provider-supports-KzFfjyO_.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-l2VYcg-y.js";
import { r as fetchWithTimeout } from "./fetch-timeout-Bv-JBzPE.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-CDoSsIec.js";
import { a as safeFileURLToPath, t as assertNoWindowsNetworkPath } from "./local-file-access-kTP7-f4T.js";
import { n as MediaFetchError, r as fetchRemoteMedia } from "./fetch-DYuedlza.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-BNXLKYs7.js";
import { t as buildRandomTempFilePath } from "./temp-download-BUrE4gKT.js";
import "./temp-path-Bbc5CO4n.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-DgdTMr7D.js";
import "./shared-VnNVR-Oq.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-DDVdPyIz.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-C6Mkn6Hf.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-CWNwL5SS.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-DEO-bprS.js");
