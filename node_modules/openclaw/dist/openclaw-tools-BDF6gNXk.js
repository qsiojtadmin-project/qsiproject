...
import { a as shouldLogVerbose, r as logVerbose } from "./globals-CX0Bl8ZU.js";
import { t as logDebug } from "./logger-D0xgIYk9.js";
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-B7QL53SS.js";
import { n as normalizeAccountId } from "./account-id-CKs_R3Vn.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-BSlq04Dw.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-BBUKdu9R.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-BcjzQKwO.js";
import { t as isWindowsDrivePath } from "./archive-path-DtOjYoSl.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-H8HAlurL.js";
import { t as applyMergePatch } from "./merge-patch-vE_MJoEo.js";
import { g as selectApplicableRuntimeConfig } from "./runtime-snapshot-Bgtbceve.js";
import { t as getProviderEnvVars } from "./provider-env-vars-BEikBWPk.js";
import { n as resolveAgentModelPrimaryValue, t as resolveAgentModelFallbackValues } from "./model-input-uXpHvROZ.js";
import { t as parseDurationMs } from "./parse-duration-BVBpwr_t.js";
import { t as isInboundPathAllowed } from "./inbound-path-policy-CSqDnJ4r.js";
import "./config-DZli1BwL.js";
import { n as isRestartEnabled } from "./commands.flags-BhE1r2Oq.js";
import { o as normalizeChannelId } from "./registry-CmNv8az5.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-DQju26jn.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-BPNeOyTS.js";
import { u as normalizeMessageChannel } from "./message-channel-DERYZbI0.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-C73VW4c-.js";
import { n as annotateInterSessionPromptText } from "./input-provenance-CYxw9P51.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-B8iKKC2A.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BwrmwWAA.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-Bm6pc8ez.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-DiLiL9Ik.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-CZGTKQyN.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-CwrlKsUf.js";
import { d as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-BIF3vVgu.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-D_T9eteF.js";
import { n as resolveSessionConversationRef } from "./session-conversation-CLMDezm1.js";
...
import { a as extractDeliveryInfo } from "./sessions-BPG8G_xx.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-B5ieQ54a.js";
import { _ as modelKey, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, v as normalizeModelRef } from "./model-selection-shared-B6u2OWdP.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BNtEtbrF.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-DZLznUc9.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CqELRWKM.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-D2iI3D5p.js";
import { r as loadModelCatalog } from "./model-catalog-Cl9-8vZQ.js";
import { i as formatDoctorNonInteractiveHint, l as removeRestartSentinelFile, n as buildRestartSuccessContinuation, p as writeRestartSentinel } from "./restart-sentinel-DQ_sBkf5.js";
import { n as extractTextFromChatContent } from "./chat-content-DdI5zu1Z.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-DFqrPvsW.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-BsmFEyNj.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, s as recordTaskRunProgressByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-gQFPyIAC.js";
import { i as callGateway } from "./call-HHsCuKDy.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-CAkDR91D.js";
import { r as stripToolMessages } from "./chat-history-text-lckshLnx.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, n as readLatestAssistantReply, r as readLatestAssistantReplySnapshot } from "./run-wait-BkKBZKZ6.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DJofUp1M.js";
import { p as registerSubagentRun } from "./subagent-registry-CBg_6tH6.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-B-mjBMYM.js";
import { _ as runAgentStep, f as ANNOUNCE_SKIP_TOKEN, g as isReplySkip, h as isNonDeliverableSessionsReply, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-session-cleanup-BDUN5Noq.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, i as normalizeToolName, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, n as expandToolGroups, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-MN-JZIlL.js";
import "./tool-policy-BL2axuiI.js";
import { a as resolvePluginTools, c as hasNonEmptyManifestEnvCandidate, d as manifestProviderBaseUrlGuardPasses, l as manifestConfigSignalPasses, u as manifestPluginSetupProviderEnvVars } from "./tools-D9CRirqH.js";
import { a as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-CaJZ_mdx.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-C1uR5ALP.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-z6yI36FD.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-Cas9gv0H.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DLlDbWSj.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-BOJ_8uxs.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-CcUn9vAQ.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-DTRuE-vY.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-Bc8Phmwd.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-Bmxw4yVw.js";
import { s as resolveTimeoutMs } from "./resolve-l2VYcg-y.js";
import { t as SsrFBlockedError } from "./ssrf-Bh_Tym8T.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-Bv-JBzPE.js";
import { a as getImageMetadata } from "./image-ops-BG4oRyrk.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-CDoSsIec.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-DM2zzBus.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-C5lfYsF1.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-kTP7-f4T.js";
import { t as buildProviderRegistry } from "./runner-DvdlGBZK.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-BNXLKYs7.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-CfJA13Af.js";
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-W0CAUUsv.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-C-HfEk7V.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-DL4WTvzI.js";
import { D as textToSpeech } from "./tts-runtime-C_xQKyqz.js";
import "./tts-Cm0MRYDz.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-BbbvhMCD.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-BX9yzI9u.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-DXjS43CZ.js";
import "./auth-profiles-lwt7gXZE.js";
import { n as listProfilesForProvider } from "./profile-list-bTJKoCyF.js";
import { r as getApiKeyForModel } from "./model-auth-JUD_7CAF.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-ByLgf0mB.js";
import { n as extractAssistantText } from "./pi-embedded-utils-4-Os8_TI.js";
import { d as parseReplyDirectives } from "./deliver-BCtMABIO.js";
import { n as runWithImageModelFallback } from "./model-fallback-7sf1gYDj.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-Rq2JD8YM.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-igDvSFxd.js";
import { n as assertSandboxPath } from "./sandbox-paths-D63o8O1C.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-C9byv8NQ.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-CCoQKQzx.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BswfNMcs.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-Dg2ko22y.js";
import "./delivery-context-DWsSvoXQ.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-BxtYtvTd.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-DMtrDRld.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-DgO4fphV.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-D3nYe3Iq.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-CSFpyG8k.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CHWUJ2u5.js";
import { t as inferLegacyName } from "./normalize-CAht-lRZ.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-_kjIcjLk.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CiTn7t_d.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-CgiCFFdT.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-BrOZZrG-.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-ArmWmVRQ.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-SycJD-Tg.js";
import { l as saveMediaBuffer } from "./store-ftuzo5rE.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-B8VEw794.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-C2QRhSH0.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-Ctnpvu5i.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-B8XOCrW7.js";
import "./media-understanding-Q7iy38yf.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-Dsohw-jl.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-C0FwO_Iu.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-CrYoXDx1.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-DdAlzlcs.js";
import { t as sendMessage } from "./message-VZxuydqK.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-CboznJ0M.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-D-NhPJx7.js";
import "./task-registry-delivery-runtime-BspLqfAO.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BTc2LcTc.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-96dIxf_m.js";
...
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-Dlg5FYYo.js";
import { t as parseTimeoutMs } from "./parse-timeout-DDTMZUWd.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CvQQZfWL.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-Xza9NjVK.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-DtfrL7Z0.js";
import { n as SUBAGENT_SPAWN_CONTEXT_MODES, r as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-Btdu5pK2.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-CPNXU6L8.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-D6blhFtm.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BDTCK3fx.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-C-O5E2MK.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-Dq3Zfa9A.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-CbbUbT1v.js";
import { i as runWebSearch } from "./runtime-QVGHfyAm.js";
import "./web-search-provider-common-TU4W745V.js";
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-BtdvPwz6.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-Ni2y4tgk.js"));
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-BeyBQCeM.js"));
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-nkdHLAQ4.js"));
...
//#endregion
export { setEmbeddedMode as S, resolveOpenClawPluginToolsForOptions as _, normalizeCronJobCreate as a, stripProviderPrefix as b, createHostWorkspaceEditTool as c, createSandboxedEditTool as d, createSandboxedReadTool as f, wrapToolWorkspaceRootGuardWithOptions as g, wrapToolWorkspaceRootGuard as h, listRuntimeMusicGenerationProviders as i, createHostWorkspaceWriteTool as l, wrapToolMemoryFlushAppendOnlyWrite as m, isParentOwnedBackgroundAcpSession as n, normalizeCronJobInput as o, createSandboxedWriteTool as p, generateMusic as r, normalizeCronJobPatch as s, createOpenClawTools as t, createOpenClawReadTool as u, isStrictAgenticExecutionContractActive as v, isEmbeddedMode as x, isStrictAgenticSupportedProviderModel as y };
