...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-DuINnI-4.js";
...
import { a as resolveSecretRefValue } from "./resolve-Wtz5DqNn.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-BcjzQKwO.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-DMMGB1uA.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-Dm1YBMh7.js";
import { n as setCommandJsonMode } from "./json-mode-DXrTW1kr.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-923bu1zc.js");
