...
import { a as normalizeChannelId, i as listChannelPlugins } from "./registry-D_T9eteF.js";
...
import { n as listBundledPackageChannelMetadata } from "./bundled-package-channel-metadata-BYsI9p4q.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-DBSmr93w.js";
import { t as formatCliChannelOptions } from "./channel-options-DwJOL6_3.js";
...
const channelsCommandsLoader = createLazyImportLoader(() => import("./channels-D9FELQ4n.js"));
...
function registerChannelsCli(program) {
	...
	channels.command("list").description("List configured channels + auth profiles").option("--no-usage", "Skip model provider usage/quota snapshots").option("--json", "Output JSON", false).action(async (opts) => {
		await runChannelsCommand(async () => {
			const { channelsListCommand } = await import("./list-CW-SxbrV.js");
	...
	channels.command("status").description("Show gateway channel status (use status --deep for local)").option("--probe", "Probe channel credentials", false).option("--timeout <ms>", "Timeout in ms", "10000").option("--json", "Output JSON", false).action(async (opts) => {
		await runChannelsCommand(async () => {
			const { channelsStatusCommand } = await import("./status-D8m1ivbm.js");
