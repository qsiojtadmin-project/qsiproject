...
import { h as stringifyRouteThreadId, o as channelRouteTargetsMatchExact } from "./channel-route-gs33uT_o.js";
import { r as createLazyRuntimeModule } from "./lazy-runtime-ByjTayCI.js";
import { n as isSingleUseReplyToMode } from "./reply-reference--eKs6xw5.js";
import { f as readNumberParam, g as readStringParam } from "./common-Rq2JD8YM.js";
import { c as normalizeMessagePresentation, s as normalizeInteractiveReply } from "./payload-DKHyAa71.js";
import { n as resolveOutboundSendDep } from "./send-deps-jTRjIYIm.js";
import { t as adaptScopedAccountAccessor } from "./channel-config-helpers-D9pao_xK.js";
import { t as buildOutboundBaseSessionKey } from "./base-session-key-DO90KoNE.js";
import "./text-runtime-BDbNycHL.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-BDe4UCri.js";
...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-DbtV6NiP.js";
...
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-Dhng7tBz.js";
import { t as resolveApprovalApprovers } from "./approval-approvers-B2dloYFP.js";
import { t as createResolvedApproverActionAuthAdapter } from "./approval-auth-helpers-tCbJ24oZ.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-OHe4dCWD.js";
...
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-45ldha4A.js";
import "./approval-native-runtime-Dq9FmPl8.js";
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-Uo0ZsiXK.js";
import "./reply-reference-Us-Ycv0u.js";
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-BCEem8ke.js";
import "./param-readers-9l9Nn8XI.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-H-kXQhUy.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-BC3sX0Kc.js";
import { a as normalizeSlackApproverId, c as shouldSuppressLocalSlackExecApprovalPrompt, i as isSlackExecApprovalClientEnabled, o as resolveSlackExecApprovalTarget, r as isSlackExecApprovalAuthorizedSender, s as shouldHandleSlackExecApprovalRequest, t as getSlackExecApprovalApprovers } from "./exec-approvals-ljrIM65R.js";
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-VLONe_fN.js";
import { t as SLACK_TEXT_LIMIT } from "./limits-DGGCY0he.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-Cqt08mk1.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-DlixhDV6.js";
import "./channel-api-B-TlQ_kP.js";
import { r as createSlackWebClient } from "./client-BgSDJTNi.js";
import { r as normalizeAllowListLower } from "./allow-list-CHEsyG5a.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-DkzMpCFy.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-Cn5I0w9F.js";
import { t as getOptionalSlackRuntime } from "./runtime-DLCedlp7.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-BmvQutxF.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-BIGK6NPU.js";
import { n as resolveSlackThreadTsValue, t as normalizeSlackThreadTsCandidate } from "./thread-ts-Cig6iA_f.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-B7Vk9T62.js")).slackApprovalNativeRuntime
	})
});
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-DcP61Dmk.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-Cqz-9OlQ.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-DU2FuUvq.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CicB8TET.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-Cf-vrXX2.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-Dsjqi3WN.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-CH3PfRl6.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-D1tHpYyN.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-nD_EjvES.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-BxasToZH.js");
