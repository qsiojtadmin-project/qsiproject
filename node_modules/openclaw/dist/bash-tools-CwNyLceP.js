...
import { a as logWarn, r as logInfo } from "./logger-D0xgIYk9.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, o as parseAgentSessionKey } from "./session-key-utils-B7QL53SS.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-BSlq04Dw.js";
import { J as getShellPathFromLoginShell, X as resolveShellEnvFallbackTimeoutMs } from "./io-BcjzQKwO.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-BozNgDpi.js";
import { t as killProcessTree } from "./kill-tree-BU1YY7px.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-DERYZbI0.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-CwrlKsUf.js";
import { n as getDiagnosticSessionState } from "./diagnostic-session-state-BWZMwwwZ.js";
import { d as sanitizeUserFacingText, h as parseExecApprovalResultText, m as isExecDeniedResultText, p as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-Cz177X8d.js";
import { t as formatDurationCompact } from "./format-duration-BtuBEz32.js";
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-MN-JZIlL.js";
import { o as failedTextResult, v as textResult } from "./common-Rq2JD8YM.js";
import { t as callGatewayTool } from "./gateway-igDvSFxd.js";
import { t as splitShellArgs } from "./shell-argv-BizYfNHO.js";
import { c as describeInterpreterInlineEval, f as analyzeShellCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, p as buildEnforcedShellCommand } from "./exec-approvals-allowlist-BgK6Z8wx.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-pAMpXFVi.js";
import { E as resolveExecApprovalAllowedDecisions, O as resolveExecApprovals, T as requiresExecApproval, _ as normalizeExecSecurity, c as hasDurableExecApproval, d as maxAsk, h as normalizeExecAsk, k as resolveExecApprovalsFromFile, o as addDurableCommandApproval, p as minSecurity, u as loadExecApprovals, w as requireValidExecTarget, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-qlTGzHgv.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-DIjRBPEi.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-CcFpznzM.js";
import "./delivery-context-DWsSvoXQ.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-D3nYe3Iq.js";
import { t as sendMessage } from "./message-VZxuydqK.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-C2SSBFIu.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-Dwdzwf6S.js";
import { f as resolveExecApprovalInitiatingSurfaceState, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-0k4hZAz9.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-VbXtAhxJ.js";
import { t as getProcessSupervisor } from "./supervisor-B0rcKN2v.js";
import { C as markExited, S as markBackgrounded, T as tail, _ as drainSession, a as DEFAULT_PENDING_MAX_OUTPUT, b as listFinishedSessions, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as deleteSession, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as getFinishedSession, w as setJobTtlMs, x as listRunningSessions, y as getSession } from "./bash-tools.exec-runtime-DtbDrPpX.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-DCljuo3O.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-2JMs3eDm.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-Ckjrgl-T.js";
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-DMdBFV0F.js"));
